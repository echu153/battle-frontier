...
// あとで調整しやすいよう1箇所に集約。宮ごとに変えたくなったら PALACE_META に cap を足す。
...
// ステ上限は現状【全宮一律】（TENKYUU_STAT_CAP）。宮ごとに変えたくなったら各エントリに
//   cap:{ atk, matk, def, mdef, spd, hp } を足すと部分上書きできる（enemy.cap→applyStatCap）。
