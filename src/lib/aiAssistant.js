...
・レイドボス(LV30)=夜21時/22時(各30分・HP700万)＋昼12〜17時のランダム1枠(30分・HP200万)の共闘ボス。全4体。ペットダンジョン(LV10)=ローグライク。奈落闘技場(LV30)=全20階(現19階)・月曜朝5時リセット。交換所(LV5)=レイド素材を装備/強化石に交換(Gold不使用)。賭博場(LV10)=メダル遊技。釣り場(LV5)=放置で魚→Gold。博物館(LV5)=装備寄贈でステボーナス。領地=建国LV100・国でエリアを取り合う。
...
・昼は12〜17時のうち毎日ランダムな1回だけ出現（30分・HP200万）。出るボスは最新ボスとその日の夜に出る2体を除いた中から1体。昼は与ダメージ上位3名の追加報酬なし。
