...
・レイドボス(LV30)=毎日21時/22時各30分・HP700万の共闘ボス3体日替わり。ペットダンジョン(LV10)=ローグライク。奈落闘技場(LV30)=全20階(現19階)・月曜朝5時リセット。交換所(LV5)=レイド素材を装備/強化石に交換(Gold不使用)。賭博場(LV10)=メダル遊技。釣り場(LV5)=放置で魚→Gold。博物館(LV5)=装備寄贈でステボーナス。領地=建国LV100・国でエリアを取り合う。
