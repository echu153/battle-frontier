...
export const KB = [
  ...
  { id: 'pets', keywords: ['ペット', '懐き', '進化', 'チャーム', '相棒', 'ヴォル', 'アルル', 'ドラム', '満腹'],
    a: `🐾 ペット（キャラLV10で解放）\n・相棒は3種から選ぶ：ヴォル（🐺／物理）・アルル（🦊／特攻）・ドラム（🐢／防御寄り）。攻撃が物理か特攻かは種族で決まる。\n・HP・攻撃・防御・特防の4ステがレベルで伸びる。\n・Lv50で「進化」できる（ヴォル→ヴォルガノフ等）。進化でステ×1.5、以降の成長量×2、レベル上限も外れて大きく伸びる。\n・チャームを装備して強化、満腹度を消費してスキルを使う。懐き度はスキンシップや出撃で上がる。\n・主にダンジョン攻略の相棒になる。` },
