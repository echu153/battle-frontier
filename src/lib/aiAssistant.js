...
export const askAssistant = async (query, ctx = {}) => {
  ...
  logUnanswered(raw)
  return {
    text: 'ごめんなさい、この質問にはまだお答えできません。🙏\nいただいた質問は記録しました。後日お答えできるように対応していきます。\n\nちなみに、こんな質問には今すぐお答えできます：\n・「狂戦士になるには？」（職名で転職条件）\n・「元素使いのスキル」「狂戦士が使える武器」\n・「メテオストライクの効果は？」（スキル/アイテム/武器/称号/交換品の名前）\n・「宝石ってなに？」「レベル上げの効率は？」\n・「おすすめ強化」（あなた専用アドバイス）',
    kind: 'fallback',
  }
}
