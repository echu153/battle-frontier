...
export const KB = [
  ...
  { id: 'drop-rate', keywords: ['ドロップ率', 'ドロップ確率', '装備ドロップ', '落とす確率', 'ドロップする確率', 'ドロップ'],
    a: `🎁 装備のドロップ率\n・通常の敵：撃破ごとに約3%でドロップ（そのうち30%はレア枠）\n・ボス：ドロップ候補それぞれ約3%で判定（候補が複数なら個別に）＋エリア固有ドロップが約5%\n・領地で自国のそのエリアのシェアが高いほどドロップ率に加算（シェア100%で最大+2%）` },
