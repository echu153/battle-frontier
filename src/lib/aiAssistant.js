...
export const KB = [
  ...
  { id: 'gems', keywords: ['宝石', 'ジェム', 'ルビー', 'サファイア', '埋め込み'],
    a: `💎 宝石(ジェム)は装備に埋め込んで追加効果。\n・攻撃系(ルビー等)→武器/装飾\n・防御系(サファイア等)→防具/装飾\n・HP/MP系→防具/装飾\n・％系(クリ/命中/回避)→装飾品のみ\nランクが上がるほど1.5倍ずつ強力(F→SSS)。主に奈落闘技場の報酬などで入手。` },
  ...
  { id: 'abyss', keywords: ['奈落', '闘技場', '挑戦'],
    a: `⚔ 奈落闘技場（キャラLV30で解放）\n・1階から順番に挑む20階のチャレンジ（撃破済みの階は再取得不可）\n・毎週月曜朝5時(JST)に進捗がリセット\n・報酬はGold・強化石・宝石\n総合力をしっかり上げてから挑みましょう。` },
  ...
  { id: 'territory', keywords: ['領地', '建国', '亡命', '国'],
    a: `🏰 領地システム\n・大陸は最大9つ。条件を満たすと自分の国を建国できます\n・建国の条件：キャラLV100以上＋非加盟国に所属＋空き大陸\n・既存の加盟国へ「亡命」して所属できます（NPC国・非加盟国を除く／元帥は亡命不可）\n・所属国から他国へ移ると7日間は領地拡大・建国ができません（非加盟国からの加入はペナルティなし）\n・領地拡大は1時間に1回、獲得量は総合力に応じて変動します` },
