...
・ステ振りはプロフィール等(1ptでHP+10/MP+5/他+1・転職しても減衰しない)。武器熟練度は出撃で上がり固定ボーナスに倍率。再修練(現クラス限定)5回でクラスLV上限が100→300。キャラLV100未満は獲得EXP1.5倍。
...
・出撃=エリア(全7)の敵/ボスと戦う。CD通常20秒/ブースト中10秒/簡易出撃60秒。ボス撃破で次エリア解放。Goldはエリア①〜④で2倍/⑤以降1.5倍。
・鍛冶屋=強化石で+強化(+ごと×1.5・上限+16)。錬金部屋=強化石を時間で自動生成(エリア③ボス撃破で稼働・F〜A)。かかし修練場(LV10)=放置専用(敵は出ない・時間でEXPのみ)。
・レイドボス(LV30)=毎日21時/22時各30分・HP100万の共闘ボス2体日替わり。ペットダンジョン(LV10)=ローグライク。奈落闘技場(LV30)=全20階(現19階)・月曜朝5時リセット。交換所(LV5)=レイド素材を装備/強化石に交換(Gold不使用)。賭博場(LV10)=メダル遊技。釣り場(LV5)=放置で魚→Gold。博物館(LV5)=装備寄贈でステボーナス。領地=建国LV100・国でエリアを取り合う。
...
export const KB = [
  ...
  { id: 'raid', keywords: ['レイド', 'レイドボス', 'あまざ', 'ヴァルゼノク', '雨摩座'],
    a: `⚔ レイドボス（キャラLV30で解放）\n・毎日21:00と22:00（各30分・JST）に出現するHP100万の共闘ボス。全プレイヤーで協力して削る。\n・ボスは2体（黒龍ヴァルゼノク／雨摩座）が日替わりで枠を入れ替える。挑戦は全員共有のクールダウン20秒。\n・1回挑むごとにEXP+10＋HP/MP全回復。貢献度（与ダメ＋挑戦回数）でA〜Dのティアが決まり、Gold・強化石・宝石・素材がもらえる。\n・ドロップ素材はボス別：黒龍ヴァルゼノク＝「黒龍の鱗／黒龍の逆鱗」、雨摩座＝「水禍の雫／雨禍の心核」。集めた素材は交換所で専用装備や強化石と交換できる。\n・ボスごとに弱点が逆（雨摩座=物理に弱め・特殊に強め／ヴァルゼノクは逆）。4ターン目に強力な専用技、10ターンで決着技がくる。` },
  ...
  { id: 'pets', keywords: ['ペット', '懐き', 'なつき', '進化', '相棒', 'ヴォル', 'アルル', 'ドラム', '満腹'],
  ...
  { id: 'account-delete', keywords: ['退会', 'アカウント削除', 'アカウントを削除', 'やめたい', 'やめる方法', 'データ削除', '消したい', '解約'],
  ...
  { id: 'heal', keywords: ['回復', '宿屋', 'ポーション', 'hp回復', 'mp回復'],
    a: `💊 HP/MPの回復\n・宿屋でHP・MPを全回復できる（Gold必要）。料金はキャラLV×2Gold、瀕死状態なら多めにかかる。\n・何もしなくても自然回復する：60秒ごとに最大HP/MPの20%ずつ（無料）。HPが満タンに戻れば瀕死も解ける。\n・戦闘中は回復スキルや回復効果の装備でも回復できる。\n出撃前に整えておけ。` },
]
