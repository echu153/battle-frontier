...
・ボス装備進化=エリアボスのドロップ装備を鍛冶屋「進化」タブで5段階進化。素材は「○○の血」(1段10/2段20/3段30/4段40)と「○○の心臓」(5段=真化に1個)。真化で基礎ステ×2＋固有特殊能力＋名前に★。血・心臓はエリアボス撃破でドロップ(血は出やすい・心臓はごく稀)。血50個→心臓1個に変換可。「ボス装備進化支援箱」=2026/7/31までのログイン特典で全員1個、アイテム画面で使うと選んだボスの血×10入手。
