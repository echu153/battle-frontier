...
export const DUNGEONS = [
  ...
  // 追憶の遺跡（30F）。敵は stats を明示指定（フロア式ではなく固定値）。名前の変種ごとにステを変える。
  {
    ...
    floorTable: [
      ...
      // エリア②（6〜9）
      { from: 6, to: 9, enemies: [
        { name: 'ゴブリン', type: 'phys', image: '/goburin.png', stats: { maxHp: 168, atk: 100, def: 55, mdef: 55 } },
        { name: '野良犬', type: 'phys', images: ['/norainu1.png', '/norainu2.png'], stats: { maxHp: 168, atk: 100, def: 55, mdef: 55 } },
        { name: '盗賊', type: 'phys', image: '/touzoku.png', stats: { maxHp: 184, atk: 110, def: 60, mdef: 60 } },
      ] },
      // エリア③（10〜19）
      { from: 10, to: 14, enemies: [
        { name: 'コボルト', type: 'phys', images: ['/koboruto.png', '/koboruto2.png'], stats: { maxHp: 272, atk: 135, def: 81, mdef: 81 } },
        { name: 'スケルトン（剣）', type: 'phys', image: '/sukerutonken.png', stats: { maxHp: 304, atk: 150, def: 90, mdef: 90 } },
        { name: 'スケルトン（弓）', type: 'phys', image: '/sukerutonyumi.png', stats: { maxHp: 256, atk: 170, def: 70, mdef: 70 } },
      ] },
      { from: 15, to: 19, enemies: [
        { name: 'スケルトン（剣）', type: 'phys', image: '/sukerutonken.png', stats: { maxHp: 304, atk: 150, def: 90, mdef: 90 } },
        { name: 'スケルトン（弓）', type: 'phys', image: '/sukerutonyumi.png', stats: { maxHp: 256, atk: 170, def: 70, mdef: 70 } },
        { name: 'ゴーレム（攻）', type: 'spec', image: '/go-remukougeki.png', stats: { maxHp: 336, atk: 210, def: 90, mdef: 90 } },
        { name: 'ゴーレム（守）', type: 'phys', image: '/go-remubougyo.png', stats: { maxHp: 520, atk: 120, def: 160, mdef: 160 } },
      ] },
      // エリア④（20〜29、30は一旦エリア④の敵で埋める。ボスは後日）
      { from: 20, to: 24, enemies: [
        { name: '深海魚人', type: 'spec', image: '/sinkaigyozin.png', stats: { maxHp: 560, atk: 210, def: 140, mdef: 140 } },
        { name: '海賊（男）', type: 'phys', image: '/kaizokuotoko.png', stats: { maxHp: 616, atk: 231, def: 154, mdef: 140 } },
        { name: '海賊（女）', type: 'spec', image: '/kaizokuonnna.png', stats: { maxHp: 560, atk: 225, def: 135, mdef: 150 } },
        { name: 'ハリセンボン', type: 'phys', image: '/harisennbonn.png', stats: { maxHp: 520, atk: 220, def: 130, mdef: 130 }, skills: [{ name: 'どくのハリ', chance: 0.35, type: 'poison' }] },
      ] },
      { from: 25, to: 30, enemies: [
        { name: '海賊（男）', type: 'phys', image: '/kaizokuotoko.png', stats: { maxHp: 616, atk: 231, def: 154, mdef: 140 } },
        { name: '海賊（女）', type: 'spec', image: '/kaizokuonnna.png', stats: { maxHp: 560, atk: 225, def: 135, mdef: 150 } },
        { name: '毒クラゲ', type: 'spec', image: '/dokukurage.png', stats: { maxHp: 560, atk: 210, def: 140, mdef: 140 }, skills: [{ name: 'どく', chance: 0.45, type: 'poison' }] },
        { name: '電気クラゲ', type: 'spec', image: '/denkikurage.png', stats: { maxHp: 560, atk: 210, def: 140, mdef: 140 }, skills: [{ name: 'しびれ', chance: 0.30, type: 'paralyze' }] },
        { name: 'ハリセンボン', type: 'phys', image: '/harisennbonn.png', stats: { maxHp: 520, atk: 220, def: 130, mdef: 130 }, skills: [{ name: 'どくのハリ', chance: 0.35, type: 'poison' }] },
      ] },
    ],
  },
