...
export const SPECIES = {
  ...
  flame:  { label: 'フラム',  emoji: '🦎', starter: true, atkType: 'phys', base: { hp: 20, atk: 10, def: 5, mdef: 3 }, grow: { hp: 6, atk: 2.4, def: 1.1, mdef: 0.7 } },
  aqua:   { label: 'アクー',  emoji: '🐟', starter: true, atkType: 'spec', base: { hp: 20, atk: 10, def: 2, mdef: 6 }, grow: { hp: 4, atk: 2.4, def: 0.8, mdef: 1.2 } },
  leaf:   { label: 'リーフィ', emoji: '🐛', starter: true, atkType: 'phys', base: { hp: 20, atk: 6,  def: 6, mdef: 6 }, grow: { hp: 8, atk: 1.0, def: 1.5, mdef: 1.5 } },
}
