...
const TICKET_CHOICES = [
  ...
  { name: 'マレディクシオン', desc: 'S級銃。攻撃60 特攻60 素早さ10。攻撃ヒット時、2ターン対象の回復力-10%。' },
  { name: '濡羽杖アマザネ',   desc: 'S級杖。特攻80 特防20。攻撃ヒット時、対象の素早さ-5%。' },
  { name: '哭雨の羽衣',       desc: 'S級防具。特攻20 特防80。戦闘開始時、1回だけ状態異常を無効化。' },
  { name: '雷鋼の機神鎧',     desc: 'S級防具。防御60 特防40。被ダメージ時、2ターン素早さ+5%。' },
  { name: '蒼雷の短刃',       desc: 'S級短剣。攻撃40 素早さ60。追加行動の攻撃ヒット時、30%で相手を麻痺させる。' },
]
