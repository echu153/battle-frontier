...
● 世の中には「アーティファクト」と呼ばれる武器があるらしい
  ...
  また使えるようになるかも…`,
    ...
    {
      id: 'menuref', title: '🏰 各メニューの使い方',
      content: `街の画面に並ぶボタンの役割を、上から順にまとめたよ。

⚔ 出撃
● エリアを選んで戦闘に出る、最も基本の行動
● 勝利でEXP・Goldを獲得し、ボス撃破で次エリアが解放される
● 10秒のクールダウンが終わると再び出撃できる

✨ デイリーダンジョン
● EXP / Gold / 強化石 / 武器熟練度 / 宝石 の5種類
● それぞれ1日5回まで・毎日朝5時（日本時間）リセット
● 通常出撃よりも報酬効率が良いので毎日こなそう
...
● 一部は管理者・先行公開中の場合があります`,
    ...
    {
      id: 'facilities2', title: '🏛 施設（博物館・交換所・錬金部屋）',
      content: `🏛 博物館
