...
【ダメージ計算】
● 物理／特殊は装備中の武器の種類で自動的に決まる（杖・魔導書・オーブなど魔法系＝特殊攻撃力、それ以外＝物理攻撃力で計算）
● ダメージは「攻撃力（特殊攻撃力）」が高いほど大きく、「敵の防御力（特殊防御力）」が高いほど軽減される
● 攻撃力 ÷（攻撃力＋敵の防御力）の割合で軽減がかかる（攻撃力が敵防御を上回るほど軽減は小さくなる）
