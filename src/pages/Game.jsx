  ...
  const GUIDE_SECTIONS = [
    {
      ...
      content: `● とにかくレベルを上げよう。レベルがすべての基本だ
● 装備も強化していこう。ボーナス値は納得がいくまで厳選しよう
● 武器には熟練度ボーナスがある。使い続けていれば能力が上昇していく
● 装備のソケットに宝石を埋め込めば、さらにステータスを底上げできる
● 転職してもステータスは下がらないが、再修練は一時的にステータスが下がるので注意。
　ステータスを伸ばしたいなら、まずは転職を繰り返すのがおすすめ
● デイリーダンジョンはとてもお得。毎日忘れずにこなしていこう
● ステータスを伸ばす手段はたくさんある。あらゆる手段を使って強くなろう！
● すぐには強くなれない。焦らず少しずつ強くなっていこう`,
    },
    {
          ...
          <div>
            ...
            {scene==='town' && (
              <div style={{ border:'1px solid #0044aa', background:'#001040', padding:'12px', marginBottom:'8px' }}>
                ...
                <button onClick={()=>nav('/casino')} style={{ width:'100%', padding:'10px', background:'#001020', border:'1px solid #ffaa00', color:'#ffaa00', cursor:'pointer', fontFamily:'monospace', fontSize:'12px' }}>🎰 賭博場へ</button>
              </div>
            )}
