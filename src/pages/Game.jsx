...
● 瀕死状態の回復は通常よりGoldが多くかかる`,
    },
    {
      ...
      content: `【初期クラス】
● 戦士・弓使い・魔法使い・僧侶・格闘家の5種類

【上位職】
● 初期クラスをLV100にすることで転職可能
● 初期クラスより強力なスキルを習得できる

【転職】
● 神殿で行える
● 他クラスで上昇したステータスは50%引き継がれる
● 再修練によって引き継ぎ（反映）率が上昇する
● 転職するとセット中のスキルは全て外れる（習得済みスキルは消えない）

【再修練】
● クラスレベル100で可能。最大5回まで
● クラスがLV1に戻りステータス上昇分はリセットされるが、特別なボーナスを得る
● 5回行うとそのクラスのレベルキャップが300に解放
〔共通〕
● 他クラスでのステータス反映率+10%
● スキルを1つ選択し、どのクラスでも使用できるようにする
〔初期クラスの場合〕
● 再修練時のステータス反映率ボーナスが+30%になる
〔上位クラスの場合〕
● そのクラスの間、スキルが強化される`,
    },
    {
