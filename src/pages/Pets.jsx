      ...
      return (
        <Wrap nav={nav} msg={msg}>
          ...
          <div style={{ border: '1px solid #335588', background: '#001026', padding: 16, textAlign: 'center' }}>
            {naming.image ? <img src={assetSrc(naming.image)} alt="" style={{ width: 84, height: 84, objectFit: 'cover', borderRadius: 6 }} /> : <div style={{ fontSize: 56 }}>{naming.emoji}</div>}
          ...
          {STARTERS.map((sp) => {
            ...
            return (
              <div key={sp.id} style={{ border: '1px solid #335588', background: '#001026', padding: 10, textAlign: 'center' }}>
                {sp.image ? <img src={assetSrc(sp.image)} alt="" style={{ width: 56, height: 56, objectFit: 'cover', borderRadius: 6 }} /> : <div style={{ fontSize: 40 }}>{sp.emoji}</div>}
