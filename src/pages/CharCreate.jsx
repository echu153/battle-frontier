...
function validateName(name) {
  ...
  if (trimmed !== name) return '名前の前後にスペースは使えません'
  if (/\s/.test(name)) return '名前にスペースは使えません'
  if (trimmed.length < 1 || trimmed.length > 16) return '名前は1〜16文字にしてください'
