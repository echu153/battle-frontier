...
export const CREATURE_WORDS = [
  ...
  'カブト', 'カゲロウ', '蛾', 'スカラベ', 'コブラ', 'ハイエナ', 'ジャッカル',
  'サメ', '鮫', 'ウミガメ', 'トビウオ', 'タコ', 'ダコ', 'イカ', 'カニ', '蟹', 'クラゲ', 'アンコウ',
  'シャチ', 'マンタ', 'メガロドン', '鯨', 'ワニ', 'マーマン', '魚人',
  // 鳥・幻獣
  'ワシ', 'オオワシ', 'フクロウ', 'ハヤブサ', 'コンドル', 'ロック鳥', '鷲', '鷹', 'ホーク', 'バード', 'バット', 'ハーピー',
...
const RARES = {
  1: [
    ...
    R({ name:'古木のトレント', kind:'phys', dist:{ hp:38, mp:5, str:18, dex:9, agi:6, int_stat:3, vit:18, luk:3 }, skills:[S.つるのむち, S.ちからため, S.かたくなる] }),
  ...
  2: [
    ...
    R({ band:'朝', name:'朝靄のオオワーム', kind:'phys', dist:{ hp:44, mp:5, str:18, dex:8, agi:5, int_stat:3, vit:14, luk:3 }, skills:[S.じわれ, S.かたくなる, S.じこさいせい] }),
    ...
    R({ band:'晩', name:'影渡りの盗賊王', kind:'phys', dist:{ hp:33, mp:6, str:17, dex:18, agi:14, int_stat:3, vit:6, luk:3 }, skills:[S.だましうち, S.すばやくなる, S.略奪] }),
  ],
  3: [
  ...
  4: [
    ...
    R({ band:'朝', name:'朝凪のセイレーン姫', kind:'mag', dist:{ hp:36, mp:10, str:3, dex:12, agi:12, int_stat:21, vit:4, luk:2 }, skills:[S.しんえんのめ, S.まりょくため, S.どくのきり] }),
  ...
  6: [
    ...
    R({ band:'昼', name:'白光のアイスドライアド', kind:'mag', dist:{ hp:36, mp:10, str:3, dex:12, agi:11, int_stat:22, vit:4, luk:2 }, skills:[S.つらら, S.まりょくため, S.どくのきり] }),
  ...
  7: [
    ...
    R({ band:'朝', name:'暁炎の大フレイムバット', kind:'phys', dist:{ hp:38, mp:7, str:21, dex:12, agi:12, int_stat:3, vit:4, luk:3 }, skills:[S.かえんだん, S.ちからため, S.すばやくなる] }),
  ...
  9: [
    ...
    R({ band:'朝', name:'陽炎の大砂トカゲ', kind:'mag', dist:{ hp:37, mp:10, str:3, dex:13, agi:13, int_stat:21, vit:1, luk:2 }, skills:[S.すなあらし, S.まりょくため, S.すばやくなる] }),
  ...
  10: [
    R({ name:'樹海の大食人樹', kind:'phys', dist:{ hp:43, mp:5, str:20, dex:8, agi:5, int_stat:3, vit:13, luk:3 }, skills:[S.つるのむち, S.かたくなる, S.じこさいせい] }),
    R({ name:'毒霧のマンドラゴラ女王', kind:'mag', dist:{ hp:37, mp:10, str:3, dex:12, agi:10, int_stat:21, vit:5, luk:2 }, skills:[S.どくのきり, S.まりょくため, S.どくばり] }),
    ...
    R({ band:'晩', name:'常闇のバンシー女王', kind:'mag', dist:{ hp:37, mp:10, str:3, dex:12, agi:12, int_stat:22, vit:2, luk:2 }, skills:[S.きょうきのぜっきょう, S.まりょくため, S.どくのきり] }),
  ],
  11: [
    R({ name:'雷翼の嵐鷲', kind:'phys', dist:{ hp:38, mp:7, str:21, dex:13, agi:15, int_stat:3, vit:2, luk:1 }, skills:[S.らくらい, S.すばやくなる, S.かぜのやいば] }),
  ...
  12: [
    ...
    R({ band:'朝', name:'朝霞の大ウィルオウィスプ', kind:'mag', dist:{ hp:37, mp:11, str:3, dex:12, agi:12, int_stat:22, vit:1, luk:2 }, skills:[S.きょうきのぜっきょう, S.まりょくため, S.どくのきり] }),
    ...
    R({ band:'晩', name:'夜霧のグレーターゾンビ', kind:'phys', dist:{ hp:41, mp:6, str:21, dex:10, agi:7, int_stat:3, vit:9, luk:3 }, skills:[S.どくのきり, S.ちからため, S.ほうたい] }),
  ],
  13: [
    ...
    R({ band:'朝', name:'曙光の大クリスタルワーム', kind:'mag', dist:{ hp:38, mp:10, str:3, dex:12, agi:10, int_stat:21, vit:4, luk:2 }, skills:[S.ほしくず, S.まりょくため, S.どくのきり] }),
    ...
    R({ band:'晩', name:'深穴のグレーターシャドウ', kind:'mag', dist:{ hp:37, mp:10, str:3, dex:13, agi:13, int_stat:22, vit:1, luk:1 }, skills:[S.しんえんのめ, S.まりょくため, S.すばやくなる] }),
  ],
  14: [
    ...
    R({ band:'昼', name:'白日のスフィンクス王', kind:'mag', dist:{ hp:38, mp:11, str:3, dex:12, agi:9, int_stat:22, vit:3, luk:2 }, skills:[S.ほしくず, S.まりょくため, S.きょうきのぜっきょう] }),
    R({ band:'晩', name:'星宿のルナウルフ王', kind:'mag', dist:{ hp:37, mp:11, str:3, dex:13, agi:12, int_stat:22, vit:1, luk:1 }, skills:[S.ほしくず, S.まりょくため, S.すばやくなる] }),
  ],
  15: [
    ...
    R({ band:'晩', name:'深海のセイレーン女帝', kind:'mag', dist:{ hp:37, mp:11, str:3, dex:12, agi:11, int_stat:22, vit:3, luk:1 }, skills:[S.しんえんのめ, S.まりょくため, S.どくのきり] }),
  ],
}
