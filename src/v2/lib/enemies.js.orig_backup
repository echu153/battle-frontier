...
export const AREAS = [
  {
    ...
    enemies: [
      ...
      A({ name:'毒キノコ', power:360, kind:'mag', dist:{ hp:34, mp:8, str:3, dex:10, agi:3, int_stat:28, vit:9, luk:5 },
        skills:[S.どくのほうし] }),
      A({ name:'森ネズミ', power:291, kind:'phys', dist:{ hp:24, mp:5, str:17, dex:16, agi:26, int_stat:3, vit:6, luk:3 },
        skills:[S.かみつく, S.すばやくなる] }),
      A({ name:'オオアリ', power:340, kind:'phys', dist:{ hp:40, mp:4, str:16, dex:8, agi:7, int_stat:3, vit:18, luk:4 },
        skills:[S.たいあたり, S.かたくなる] }),
      A({ name:'つるヘビ', power:382, kind:'phys', dist:{ hp:30, mp:4, str:25, dex:12, agi:11, int_stat:3, vit:11, luk:4 },
    ...
    timed: [
      ...
      A({ band:'朝', name:'朝もやのカエル', power:430, kind:'mag', dist:{ hp:34, mp:9, str:2, dex:9, agi:6, int_stat:26, vit:11, luk:3 },
        skills:[S.どくのほうし] }),
      A({ band:'昼', name:'ひなたのチョウ', power:430, kind:'mag', dist:{ hp:28, mp:10, str:3, dex:12, agi:11, int_stat:30, vit:3, luk:3 },
        skills:[S.どくのほうし, S.すばやくなる] }),
      A({ band:'晩', name:'夜鳴きのコオロギ', power:430, kind:'phys', dist:{ hp:26, mp:6, str:18, dex:26, agi:15, int_stat:3, vit:3, luk:3 },
        skills:[S.ひっかく, S.すばやくなる] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'草原オオカミ', power:485, kind:'phys', dist:{ hp:24, mp:5, str:17, dex:16, agi:26, int_stat:3, vit:6, luk:3 },
        skills:[S.かみつく, S.すばやくなる] }),
      A({ name:'ゴブリン射手', power:556, kind:'phys', dist:{ hp:26, mp:6, str:17, dex:26, agi:17, int_stat:3, vit:2, luk:3 },
        skills:[S.かぜのやいば, S.すばやくなる] }),
      A({ name:'野伏せのイノシシ', power:636, kind:'phys', dist:{ hp:40, mp:4, str:17, dex:8, agi:5, int_stat:3, vit:19, luk:4 },
    ...
    timed: [
      ...
      A({ band:'晩', name:'夜盗の斥候', power:720, kind:'phys', dist:{ hp:26, mp:7, str:20, dex:22, agi:18, int_stat:3, vit:2, luk:2 },
        skills:[S.だましうち, S.すばやくなる] }),
      A({ band:'朝', name:'朝露のオオバッタ', power:720, kind:'phys', dist:{ hp:24, mp:5, str:17, dex:16, agi:26, int_stat:3, vit:6, luk:3 },
        skills:[S.かぜのやいば] }),
      A({ band:'昼', name:'炎天のハゲタカ', power:720, kind:'phys', dist:{ hp:30, mp:4, str:24, dex:12, agi:13, int_stat:3, vit:10, luk:4 },
        skills:[S.ひっかく, S.すばやくなる] }),
      A({ band:'晩', name:'夜盗の番犬', power:720, kind:'phys', dist:{ hp:30, mp:4, str:25, dex:12, agi:11, int_stat:3, vit:11, luk:4 },
        skills:[S.かみつく, S.さけび] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'洞窟グモ', power:795, kind:'phys', dist:{ hp:26, mp:6, str:16, dex:26, agi:16, int_stat:3, vit:4, luk:3 },
    ...
    timed: [
      ...
      A({ band:'朝', name:'朝陰のオオムカデ', power:1150, kind:'phys', dist:{ hp:30, mp:4, str:23, dex:12, agi:12, int_stat:3, vit:12, luk:4 },
        skills:[S.どくばり, S.ほねきり] }),
      A({ band:'昼', name:'石窟のサソリ', power:1150, kind:'phys', dist:{ hp:40, mp:4, str:16, dex:8, agi:7, int_stat:3, vit:18, luk:4 },
        skills:[S.どくばり, S.かたくなる] }),
      A({ band:'晩', name:'亡霊コボルト', power:1150, kind:'mag', dist:{ hp:28, mp:10, str:4, dex:12, agi:9, int_stat:30, vit:4, luk:3 },
        skills:[S.きょうきのぜっきょう] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'グリフォン', power:2350, kind:'phys', dist:{ hp:26, mp:5, str:22, dex:14, agi:25, int_stat:3, vit:3, luk:2 },
        skills:[S.ひっかく, S.すばやくなる] }),
      A({ name:'峰のオオワシ', power:2134, kind:'phys', dist:{ hp:24, mp:5, str:17, dex:16, agi:26, int_stat:3, vit:6, luk:3 },
        skills:[S.れっぷうそう, S.すばやくなる] }),
      A({ name:'山岳トロール', power:2575, kind:'phys', dist:{ hp:40, mp:4, str:16, dex:8, agi:7, int_stat:3, vit:18, luk:4 },
        skills:[S.こんぼう, S.かたくなる] }),
      A({ name:'岩場のヒグマ', power:2491, kind:'phys', dist:{ hp:30, mp:4, str:25, dex:12, agi:11, int_stat:3, vit:11, luk:4 },
    ...
    timed: [
      ...
      A({ band:'晩', name:'宵闇の山猫', power:3000, kind:'phys', dist:{ hp:25, mp:6, str:23, dex:16, agi:26, int_stat:2, vit:1, luk:1 },
        skills:[S.ひっかく, S.すばやくなる] }),
      A({ band:'朝', name:'払暁のハヤブサ', power:3000, kind:'phys', dist:{ hp:26, mp:6, str:16, dex:26, agi:16, int_stat:3, vit:4, luk:3 },
        skills:[S.かぜのやいば] }),
      A({ band:'昼', name:'陽射しのヤマアラシ', power:3000, kind:'phys', dist:{ hp:40, mp:4, str:16, dex:8, agi:7, int_stat:3, vit:18, luk:4 },
        skills:[S.どくばり, S.かたくなる] }),
      A({ band:'晩', name:'宵闇のオオカミ', power:3000, kind:'phys', dist:{ hp:24, mp:5, str:19, dex:16, agi:25, int_stat:3, vit:5, luk:3 },
        skills:[S.かみつく, S.すばやくなる] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'氷壁のゴーレム', power:3880, kind:'phys', dist:{ hp:40, mp:4, str:15, dex:8, agi:6, int_stat:3, vit:20, luk:4 },
        skills:[S.いわなげ, S.かたくなる] }),
      A({ name:'白銀のシロクマ', power:4532, kind:'phys', dist:{ hp:30, mp:4, str:24, dex:12, agi:13, int_stat:3, vit:10, luk:4 },
        skills:[S.ひっかく, S.ちからため] }),
      A({ name:'霜のスケルトン', power:4134, kind:'phys', dist:{ hp:40, mp:4, str:17, dex:8, agi:5, int_stat:3, vit:19, luk:4 },
        skills:[S.ほねきり, S.かたくなる] }),
    ],
    timed: [
      ...
      A({ band:'朝', name:'朝焼けのアイスドレイク', power:5280, kind:'mag', dist:{ hp:28, mp:10, str:2, dex:12, agi:10, int_stat:30, vit:5, luk:3 },
        skills:[S.つらら, S.まりょくため] }),
      A({ band:'昼', name:'白光のスノーハーピー', power:5280, kind:'phys', dist:{ hp:26, mp:6, str:17, dex:26, agi:17, int_stat:3, vit:2, luk:3 },
        skills:[S.かぜのやいば] }),
      A({ band:'晩', name:'極夜のリッチ', power:5280, kind:'mag', dist:{ hp:28, mp:10, str:4, dex:12, agi:9, int_stat:30, vit:4, luk:3 },
        skills:[S.つらら, S.まりょくため] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'溶岩スライム', power:6790, kind:'mag', dist:{ hp:34, mp:9, str:2, dex:9, agi:6, int_stat:26, vit:11, luk:3 },
        skills:[S.かえんだん, S.かたくなる] }),
      A({ name:'火口のヘルハウンド', power:8034, kind:'phys', dist:{ hp:24, mp:5, str:18, dex:16, agi:27, int_stat:3, vit:4, luk:3 },
        skills:[S.かみつく, S.ちからため] }),
      A({ name:'燃えさかるインプ', power:7844, kind:'mag', dist:{ hp:28, mp:10, str:4, dex:12, agi:9, int_stat:30, vit:4, luk:3 },
        skills:[S.かえんだん, S.まりょくため] }),
    ],
    timed: [
      ...
      A({ band:'朝', name:'暁炎のフェニックス', power:9360, kind:'mag', dist:{ hp:28, mp:10, str:2, dex:12, agi:10, int_stat:30, vit:5, luk:3 },
        skills:[S.かえんだん, S.じこさいせい] }),
      A({ band:'昼', name:'陽炎のケルベロス', power:9360, kind:'phys', dist:{ hp:30, mp:4, str:24, dex:12, agi:13, int_stat:3, vit:10, luk:4 },
        skills:[S.かみつく, S.さけび] }),
      A({ band:'晩', name:'熾火のワイバーン', power:9360, kind:'phys', dist:{ hp:30, mp:4, str:25, dex:12, agi:11, int_stat:3, vit:11, luk:4 },
        skills:[S.ようがんけん, S.ちからため] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'蒼天のロック鳥', power:10670, kind:'phys', dist:{ hp:30, mp:4, str:23, dex:12, agi:12, int_stat:3, vit:12, luk:4 },
        skills:[S.そうてんとつげき, S.ちからため] }),
      A({ name:'浮遊するゴーレム', power:11845, kind:'phys', dist:{ hp:40, mp:4, str:16, dex:8, agi:7, int_stat:3, vit:18, luk:4 },
        skills:[S.いわなげ, S.かたくなる] }),
      A({ name:'天空の弓兵', power:13250, kind:'phys', dist:{ hp:26, mp:6, str:18, dex:26, agi:15, int_stat:3, vit:3, luk:3 },
        skills:[S.かぜのやいば, S.すばやくなる] }),
    ],
    timed: [
      ...
      A({ band:'晩', name:'星降りのヴァルキリー', power:15000, kind:'phys', dist:{ hp:29, mp:8, str:26, dex:14, agi:13, int_stat:4, vit:4, luk:2 },
        skills:[S.そうてんとつげき, S.ちからため] }),
      A({ band:'朝', name:'曙光のケルビム', power:15000, kind:'mag', dist:{ hp:28, mp:10, str:2, dex:12, agi:10, int_stat:30, vit:5, luk:3 },
        skills:[S.ほしくず, S.じこさいせい] }),
      A({ band:'昼', name:'白昼のユニコーン', power:15000, kind:'phys', dist:{ hp:24, mp:5, str:18, dex:16, agi:27, int_stat:3, vit:4, luk:3 },
        skills:[S.そうてんとつげき, S.すばやくなる] }),
      A({ band:'晩', name:'星降りのワイバーン', power:15000, kind:'phys', dist:{ hp:30, mp:4, str:25, dex:12, agi:11, int_stat:3, vit:11, luk:4 },
        skills:[S.そうてんとつげき, S.ちからため] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'影狼シャドウウルフ', power:2350, kind:'phys', dist:{ hp:26, mp:5, str:24, dex:14, agi:25, int_stat:2, vit:2, luk:2 },
        skills:[S.かみつく, S.すばやくなる] }),
      A({ name:'樹海のオオグモ', power:2328, kind:'phys', dist:{ hp:26, mp:6, str:16, dex:26, agi:16, int_stat:3, vit:4, luk:3 },
        skills:[S.どくばり, S.すばやくなる] }),
      A({ name:'苔むしたゴーレム', power:2318, kind:'phys', dist:{ hp:40, mp:4, str:16, dex:8, agi:7, int_stat:3, vit:18, luk:4 },
        skills:[S.いわなげ, S.かたくなる] }),
      A({ name:'人喰いのツタ', power:2491, kind:'phys', dist:{ hp:30, mp:4, str:25, dex:12, agi:11, int_stat:3, vit:11, luk:4 },
    ...
    timed: [
      ...
      A({ band:'朝', name:'朝靄のマイコニド', power:3000, kind:'mag', dist:{ hp:34, mp:9, str:2, dex:9, agi:6, int_stat:26, vit:11, luk:3 },
        skills:[S.どくのほうし] }),
      A({ band:'昼', name:'木漏れ日のオオカブト', power:3000, kind:'phys', dist:{ hp:40, mp:4, str:16, dex:8, agi:7, int_stat:3, vit:18, luk:4 },
        skills:[S.たいあたり, S.ちからため] }),
      A({ band:'晩', name:'常闇のオオコウモリ', power:3000, kind:'phys', dist:{ hp:24, mp:5, str:19, dex:16, agi:25, int_stat:3, vit:5, luk:3 },
        skills:[S.かみつく, S.すばやくなる] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'断崖のコンドル', power:3977, kind:'phys', dist:{ hp:24, mp:5, str:17, dex:16, agi:26, int_stat:3, vit:6, luk:3 },
        skills:[S.れっぷうそう, S.すばやくなる] }),
      A({ name:'帯電のゴーレム', power:4429, kind:'mag', dist:{ hp:34, mp:9, str:3, dex:9, agi:7, int_stat:26, vit:9, luk:3 },
        skills:[S.でんげき, S.かたくなる] }),
      A({ name:'雷牙のオオカミ', power:4240, kind:'phys', dist:{ hp:30, mp:4, str:25, dex:12, agi:11, int_stat:3, vit:11, luk:4 },
        skills:[S.かみつく, S.すばやくなる] }),
    ],
    timed: [
      ...
      A({ band:'朝', name:'暁雲のグリフォン', power:5280, kind:'phys', dist:{ hp:30, mp:4, str:23, dex:12, agi:12, int_stat:3, vit:12, luk:4 },
        skills:[S.れっぷうそう, S.ちからため] }),
      A({ band:'昼', name:'雷光のドレイク', power:5280, kind:'mag', dist:{ hp:28, mp:10, str:3, dex:12, agi:11, int_stat:30, vit:3, luk:3 },
        skills:[S.らくらい, S.まりょくため] }),
      A({ band:'晩', name:'雷鳴のハーピー', power:5280, kind:'phys', dist:{ hp:26, mp:6, str:18, dex:26, agi:15, int_stat:3, vit:3, luk:3 },
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'沼のオオワニ', power:7372, kind:'phys', dist:{ hp:30, mp:4, str:23, dex:12, agi:12, int_stat:3, vit:12, luk:4 },
        skills:[S.かみつく, S.ちからため] }),
      A({ name:'腐肉のオオバエ', power:7210, kind:'phys', dist:{ hp:24, mp:5, str:18, dex:16, agi:27, int_stat:3, vit:4, luk:3 },
        skills:[S.どくばり, S.すばやくなる] }),
      A({ name:'泥のゴーレム', power:7844, kind:'phys', dist:{ hp:40, mp:4, str:17, dex:8, agi:5, int_stat:3, vit:19, luk:4 },
        skills:[S.いわなげ, S.かたくなる] }),
    ],
    timed: [
      ...
      A({ band:'朝', name:'朝霞のオオヒル', power:9360, kind:'phys', dist:{ hp:40, mp:4, str:15, dex:8, agi:6, int_stat:3, vit:20, luk:4 },
        skills:[S.しょくしゅ] }),
      A({ band:'昼', name:'陽だまりのオオヘビ', power:9360, kind:'phys', dist:{ hp:30, mp:4, str:24, dex:12, agi:13, int_stat:3, vit:10, luk:4 },
        skills:[S.どくばり, S.すばやくなる] }),
      A({ band:'晩', name:'夜霧のバジリスク', power:9360, kind:'mag', dist:{ hp:28, mp:10, str:4, dex:12, agi:9, int_stat:30, vit:4, luk:3 },
        skills:[S.どくのきり, S.まりょくため] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'闇喰いコウモリ', power:7000, kind:'phys', dist:{ hp:26, mp:7, str:23, dex:15, agi:26, int_stat:2, vit:1, luk:0 },
        skills:[S.かみつく, S.すばやくなる] }),
      A({ name:'坑道のオオネズミ', power:6984, kind:'phys', dist:{ hp:24, mp:5, str:17, dex:16, agi:26, int_stat:3, vit:6, luk:3 },
        skills:[S.かみつく, S.すばやくなる] }),
      A({ name:'錆びた自動人形', power:8034, kind:'phys', dist:{ hp:40, mp:4, str:16, dex:8, agi:7, int_stat:3, vit:18, luk:4 },
        skills:[S.こんぼう, S.かたくなる] }),
      A({ name:'奈落のスケルトン兵', power:7420, kind:'phys', dist:{ hp:30, mp:4, str:25, dex:12, agi:11, int_stat:3, vit:11, luk:4 },
    ...
    timed: [
      ...
      A({ band:'晩', name:'深穴のシャドウ', power:9360, kind:'mag', dist:{ hp:28, mp:10, str:3, dex:12, agi:17, int_stat:27, vit:1, luk:2 },
        skills:[S.きょうきのぜっきょう, S.まりょくため] }),
      A({ band:'朝', name:'曙光のクリスタルゴーレム', power:9360, kind:'mag', dist:{ hp:34, mp:9, str:2, dex:9, agi:6, int_stat:26, vit:11, luk:3 },
        skills:[S.いわなげ, S.まりょくため] }),
      A({ band:'昼', name:'灯火のドワーフ坑夫', power:9360, kind:'phys', dist:{ hp:30, mp:4, str:24, dex:12, agi:13, int_stat:3, vit:10, luk:4 },
        skills:[S.こんぼう, S.ちからため] }),
      A({ band:'晩', name:'深穴のオオグモ', power:9360, kind:'phys', dist:{ hp:26, mp:6, str:18, dex:26, agi:15, int_stat:3, vit:3, luk:3 },
        skills:[S.どくばり, S.すばやくなる] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'遺跡の守護機兵', power:12500, kind:'phys', dist:{ hp:32, mp:5, str:25, dex:12, agi:8, int_stat:3, vit:12, luk:3 },
      ...
      A({ name:'時喰いのクロノワーム', power:11000, kind:'phys', dist:{ hp:30, mp:7, str:22, dex:13, agi:20, int_stat:4, vit:2, luk:2 },
        skills:[S.かぜのやいば, S.すばやくなる] }),
      A({ name:'星霜のゴーレム', power:11640, kind:'phys', dist:{ hp:40, mp:4, str:15, dex:8, agi:6, int_stat:3, vit:20, luk:4 },
        skills:[S.じわれ, S.かたくなる] }),
      A({ name:'遺跡の魔導兵', power:12875, kind:'mag', dist:{ hp:28, mp:10, str:3, dex:12, agi:11, int_stat:30, vit:3, luk:3 },
        skills:[S.ほしくず, S.まりょくため] }),
      A({ name:'時喰いのカゲロウ', power:11660, kind:'phys', dist:{ hp:24, mp:5, str:19, dex:16, agi:25, int_stat:3, vit:5, luk:3 },
        skills:[S.かぜのやいば, S.すばやくなる] }),
    ],
    timed: [
      ...
      A({ band:'昼', name:'白日のスフィンクス', power:15000, kind:'mag', dist:{ hp:31, mp:10, str:3, dex:11, agi:9, int_stat:28, vit:6, luk:2 },
        skills:[S.ほしくず, S.まりょくため] }),
      A({ band:'晩', name:'星宿の月狼ルナウルフ', power:15000, kind:'mag', dist:{ hp:28, mp:11, str:2, dex:12, agi:16, int_stat:28, vit:1, luk:2 },
        skills:[S.ほしくず, S.きょうきのぜっきょう] }),
      A({ band:'朝', name:'暁星のケンタウロス', power:15000, kind:'phys', dist:{ hp:26, mp:6, str:16, dex:26, agi:16, int_stat:3, vit:4, luk:3 },
        skills:[S.かぜのやいば, S.ちからため] }),
      A({ band:'昼', name:'白日のマンティコア', power:15000, kind:'phys', dist:{ hp:30, mp:4, str:24, dex:12, agi:13, int_stat:3, vit:10, luk:4 },
        skills:[S.ひっかく, S.さけび] }),
      A({ band:'晩', name:'星宿の月蛾', power:15000, kind:'mag', dist:{ hp:28, mp:10, str:4, dex:12, agi:9, int_stat:30, vit:4, luk:3 },
        skills:[S.ほしくず, S.まりょくため] }),
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      A({ name:'深海のメガロドン', power:12125, kind:'phys', dist:{ hp:30, mp:4, str:23, dex:12, agi:12, int_stat:3, vit:12, luk:4 },
        skills:[S.かみつく, S.ちからため] }),
      A({ name:'海溝のダイオウイカ', power:12154, kind:'phys', dist:{ hp:30, mp:4, str:24, dex:12, agi:13, int_stat:3, vit:10, luk:4 },
        skills:[S.しょくしゅ, S.すばやくなる] }),
      A({ name:'冥暗のマーマン', power:11660, kind:'phys', dist:{ hp:26, mp:6, str:18, dex:26, agi:15, int_stat:3, vit:3, luk:3 },
        skills:[S.しおのやり, S.すばやくなる] }),
    ],
    timed: [
      ...
      A({ band:'昼', name:'陽射しの巨鯨', power:15000, kind:'phys', dist:{ hp:38, mp:6, str:24, dex:8, agi:6, int_stat:3, vit:12, luk:3 },
        skills:[S.まるのみ, S.かたくなる] }),
      A({ band:'晩', name:'深海のセイレーン', power:15000, kind:'mag', dist:{ hp:29, mp:11, str:2, dex:11, agi:13, int_stat:29, vit:3, luk:2 },
        skills:[S.しんえんのめ, S.きょうきのぜっきょう] }),
      A({ band:'朝', name:'朝凪のシャチ', power:15000, kind:'phys', dist:{ hp:30, mp:4, str:23, dex:12, agi:12, int_stat:3, vit:12, luk:4 },
        skills:[S.たいあたり, S.ちからため] }),
      A({ band:'昼', name:'陽射しのマンタ', power:15000, kind:'phys', dist:{ hp:24, mp:5, str:18, dex:16, agi:27, int_stat:3, vit:4, luk:3 },
        skills:[S.かぜのやいば, S.すばやくなる] }),
      A({ band:'晩', name:'深海のオオダコ', power:15000, kind:'mag', dist:{ hp:28, mp:10, str:4, dex:12, agi:9, int_stat:30, vit:4, luk:3 },
        skills:[S.しんえんのめ, S.まりょくため] }),
    ],
