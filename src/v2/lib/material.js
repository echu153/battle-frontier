...
const RARE_DEF = {
  ...
  4: [
    ...
    ['朝凪のセイレーン姫', ['int_stat'], ['セイレーン姫の鱗', 'セイレーンの歌片', 'セイレーン姫の宝冠'], '朝'],
  ...
  9: [
    ...
    ['陽炎の大砂トカゲ', ['int_stat'], ['大砂トカゲの砂鱗', '大砂トカゲの熱鱗', '大砂トカゲの灼核'], '朝'],
    ['灼熱の冥王アヌビス', ['str'], ['灼熱の獣毛', '冥王の杖片', 'アヌビスの冥核'], '昼'],
    ['月砂の狼王', ['agi'], ['月砂の毛皮', '狼王の砂牙', '月砂王の心臓'], '晩'],
  ],
  10: [
    ['樹海の大食人樹', ['hp'], ['樹海の樹皮', '大食人樹の顎木', '大食人樹の樹心'], null],
    ['毒霧のマンドラゴラ女王', ['int_stat'], ['毒霧の根片', 'マンドラゴラ女王の葉', 'マンドラゴラ女王の毒核'], null],
    ['朝靄の古樹王', ['vit'], ['朝靄の苔皮', '古樹王の年輪', '古樹王の巨心'], '朝'],
    ['木漏れ日の妖精姫', ['mp'], ['木漏れ日の鱗粉', '妖精姫の羽衣', '妖精姫の光冠'], '昼'],
    ['常闇のバンシー女王', ['int_stat'], ['バンシーの哭布', 'バンシー女王の涙晶', 'バンシー女王の呪核'], '晩'],
  ],
  11: [
    ['雷翼の嵐鷲', ['agi'], ['雷翼の羽根', '嵐鷲の嘴', '嵐鷲の雷核'], null],
  ...
  12: [
    ...
    ['朝霞の大ウィルオウィスプ', ['mp'], ['朝霞の鬼火片', '大ウィルオウィスプの灯芯', '大ウィルオウィスプの霊核'], '朝'],
    ['陽だまりの毒蛙王', ['vit'], ['陽だまりの毒皮', '毒蛙王の毒腺', '毒蛙王の巨心'], '昼'],
    ['夜霧のグレーターゾンビ', ['str'], ['夜霧の腐肉', 'グレーターゾンビの朽骨', 'グレーターゾンビの疫核'], '晩'],
  ],
  13: [
    ['坑道の屍鬼王', ['str'], ['坑道の腐爪', '屍鬼王の顎骨', '屍鬼王の飢核'], null],
    ['鉱晶のゴーレム将', ['vit'], ['鉱晶の岩片', 'ゴーレム将の晶柱', '鉱晶将の動力核'], null],
    ['曙光の大クリスタルワーム', ['int_stat'], ['曙光の晶殻', '大クリスタルワームの晶角', '大クリスタルワームの輝核'], '朝'],
    ['灯火のドワーフ王', ['dex'], ['灯火の鉱片', 'ドワーフ王の鎚', 'ドワーフ王の炉心'], '昼'],
    ['深穴のグレーターシャドウ', ['agi'], ['深穴の影片', 'グレーターシャドウの暗衣', 'グレーターシャドウの虚核'], '晩'],
  ],
  14: [
    ['星読みの大石像', ['int_stat'], ['大石像の石片', '大石像の星盤', '星読みの天球核'], null],
    ['遺跡の守護機神', ['vit'], ['守護機神の外装', '機神の魔導回路', '機神の中枢核'], null],
    ['暁星の星辰騎士', ['str'], ['暁星の甲片', '星辰騎士の剣先', '星辰騎士の星心'], '朝'],
    ['白日のスフィンクス王', ['int_stat'], ['白日の獅毛', 'スフィンクス王の謎符', 'スフィンクス王の白日核'], '昼'],
    ['星宿のルナウルフ王', ['mp'], ['ルナウルフ王の月毛', 'ルナウルフ王の月衣', 'ルナウルフ王の宿星核'], '晩'],
  ],
  15: [
    ...
    ['深海のセイレーン女帝', ['int_stat'], ['深海の鱗片', 'セイレーン女帝の歌晶', 'セイレーン女帝の深冠'], '晩'],
  ],
}
