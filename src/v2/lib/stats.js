...
export const STAT_DEFS = {
  ...
  int_stat: { label:'INT', jp:'知性', unit:1, color:'#cc44ff',
    desc:'魔法と魔法防御',
    detail:'魔法スキルの威力と、魔法防御（魔法ダメージを最大50%軽減）。HP・MPの回復量もINTで決まる。' },
  vit: { label:'VIT', jp:'耐久', unit:1, color:'#88aaff',
    desc:'受ける物理ダメージ',
    detail:'物理ダメージを最大34%まで軽減する。魔法防御と回避にもわずかに乗る。' },
  luk: { label:'LUK', jp:'幸運', unit:1, color:'#ffdd66',
    desc:'クリティカル',
    detail:'相手より高いほどクリティカルが出やすく、相手からは受けにくくなる（1〜50%）。クリティカルは威力が上がり相手の防御の約1/3を無視する。クリティカル時の命中と、回避にもわずかに乗る。' },
}
