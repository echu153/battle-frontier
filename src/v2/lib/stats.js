...
export const STAT_DEFS = {
  ...
  str: { label:'STR', jp:'腕力', unit:1, color:'#ffcc00',
    desc:'物理の威力',
    detail:'通常攻撃と物理スキルのダメージ。' },
  dex: { label:'DEX', jp:'器用', unit:1, color:'#88ddaa',
    desc:'命中と安定',
    detail:'相手の回避率を押し下げて攻撃を当てる。さらにダメージの下振れを減らす。' },
  agi: { label:'AGI', jp:'敏捷', unit:1, color:'#ff8844',
    desc:'回避と速さ',
    detail:'相手の攻撃を避ける。行動順を決め、相手より速いと確率で追加行動ができる。' },
  ...
  luk: { label:'LUK', jp:'幸運', unit:1, color:'#ffdd66',
    desc:'クリティカル',
    detail:'相手より高いほどクリティカルが出る。クリティカルは威力が上がり、相手の防御の約1/3を無視する。回避にもわずかに乗る。' },
}
