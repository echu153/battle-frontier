...
export const SKILLS = [
  ...
  { name:'影裂き',   cls:'暗殺者', kind:'phys', mult:0.46, add:[{ stat:'agi', rate:0.2 }], hits:3, proc:85, mp:16, noCrit:true, ail:{ key:'bleed', chance:25 }, ailPerHit:true, desc:'3連撃。クリティカルしない。1発ごとに25%で出血。AGIも威力になる' },
  ...
  { name:'千刃乱舞', cls:'暗殺者', kind:'phys', mult:0.4, add:[{ stat:'agi', rate:0.15 }], hits:4, proc:80, mp:20, noCrit:true, ail:{ key:'bleed', chance:30 }, reqJobs:5, desc:'4連撃。30%で出血。AGIも威力になる。クリティカルしない' },
