...
export const SKILLS = [
  ...
  { name:'ライトニングボルト', cls:'元素使い', kind:'mag', mult:2.29, proc:85, mp:17, ail:{ key:'paralyze', chance:8 }, desc:'雷の魔法。8%で麻痺' },
  { name:'フレイムバースト', cls:'元素使い', kind:'mag', mult:2.62, proc:80, mp:21, desc:'元素使いの切り札' },
