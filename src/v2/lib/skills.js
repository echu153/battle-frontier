...
export const SKILLS = [
  ...
  { name:'幽世ノ門',   cls:'死霊使い', kind:'mag', mult:1.86, add:[{ stat:'int_stat', rate:0.4 }], proc:80, mp:21, buff:{ enemy:{ vit:-20, agi:-20 } }, drain:0.15, desc:'冥府へ引きずり込む。相手のVIT・AGI-20%（重ねがけ可）。与えたダメージの15%を吸収。INTも威力になる' },
  ...
  { name:'カースハンド',   cls:'死霊使い', kind:'mag', mult:1.78, add:[{ stat:'int_stat', rate:0.3 }], proc:90, mp:13, ail:{ key:'healCut', chance:40, pct:30 }, reqJobs:5, desc:'亡者の手が伸びる。40%で回復阻害（回復量-30%）。INTも威力になる' },
  ...
  { name:'デスウェイル', cls:'死霊使い', kind:'mag', mult:1.8, add:[{ stat:'int_stat', rate:0.3 }], proc:85, mp:17, buff:{ enemy:{ str:-20, agi:-20 } }, ail:{ key:'healCut', chance:35 }, reqJobs:5, desc:'怯ませる。相手のSTR・AGI-20%（重ねがけ可）。35%で回復阻害。INTも威力になる' },
  { name:'ヘルチェイン',   cls:'死霊使い', kind:'mag', mult:2.06, add:[{ stat:'int_stat', rate:0.4 }], proc:80, mp:21, ail:{ key:'slow', chance:40 }, reqJobs:5, desc:'鎖で縛りつける。40%で鈍足。INTも威力になる' },
  ...
  { name:'ホーリーエッジ',     cls:'聖騎士', kind:'phys', mult:1.36, add:[{ stat:'str', rate:0.5 }], proc:90, mp:12, buff:{ self:{ vit:15 } }, desc:'STRが大きく威力になる。自分のVIT+15%（重ねがけ可）' },
  ...
  { name:'神聖覚醒',           cls:'聖騎士', kind:'phys', mult:1.75, add:[{ stat:'str', rate:0.6 }], proc:80, mp:20, desc:'VITも大きく威力になる。STRが大きく威力になる' },
  ...
  { name:'ラストガード',         cls:'聖騎士', kind:'phys', mult:1.67, add:[{ stat:'str', rate:0.5 }], proc:82, mp:18, buff:{ self:{ vit:20 } }, reqJobs:5, desc:'守りを固めながら殴る。STRが大きく威力になる・自分のVIT+20%（重ねがけ可）' },
  ...
  { name:'マナバースト', cls:'魔法剣士', kind:'mag', mult:1.67, add:[{ stat:'int_stat', rate:0.4 }], proc:85, mp:17, switchKind:30, reqJobs:5, desc:'INTも威力になる。直前に物理を使っていれば威力+30%' },
  ...
  { name:'サイキックチェイン', cls:'サイキッカー', kind:'phys', src:'str', mult:0.48, add:[{ stat:'int_stat', rate:0.15 }, { stat:'int_stat', rate:0.15 }], hits:3, proc:80, mp:20, noCrit:true, reqJobs:5, desc:'3連撃。INTも威力になる。クリティカルしない' },
