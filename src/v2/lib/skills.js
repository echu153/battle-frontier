...
export const SKILLS = [
  ...
  { name:'応急手当',   cls:'ノーブル', kind:'heal', proc:85, mp:8,  heal:{ rate:0.7 }, desc:'手当てしてHPを戻す' },
  ...
  { name:'シールドアタック', cls:'戦士', kind:'phys', mult:0.89, add:[{ stat:'vit', rate:0.5 }], proc:90, mp:8, desc:'盾で殴る。VITが大きく威力になる' },
  { name:'狙撃',     cls:'弓使い', kind:'phys', mult:0.65, add:[{ stat:'agi', rate:0.6 }], proc:90, mp:8, sureHit:true, desc:'必中。AGIが大きく威力になる' },
  ...
  { name:'疾風矢',   cls:'弓使い', kind:'phys', mult:0.89, add:[{ stat:'agi', rate:0.5 }], proc:90, mp:8, desc:'速射。AGIが大きく威力になる' },
  ...
  { name:'ヒール',       cls:'僧侶', kind:'heal', proc:85, mp:12, heal:{ rate:1.2 }, desc:'光を当ててHPを戻す' },
  { name:'祈祷',         cls:'僧侶', kind:'heal', proc:85, mp:15, regen:{ rate:0.6, turns:4 }, desc:'祈り続けて、しばらく毎ターンHPが戻る' },
  ...
  { name:'魔力供給',       cls:'サモナー', kind:'heal', proc:85, mp:0, mpRegen:{ rate:0.2, turns:4 }, desc:'しばらく毎ターンMPが戻る。消費MPなし' },
  ...
  { name:'抜刀術',   cls:'侍', kind:'phys', mult:1.74, add:[{ stat:'dex', rate:0.3 }], proc:88, mp:14, stance:{ proc:20, mult:1.5, priority:true }, desc:'軽く斬りつけてから鞘に納める。斬りながら納刀に入る。DEXも威力になる' },
  ...
  { name:'血の渇き', cls:'狂戦士', kind:'phys', mult:1.88, add:[{ stat:'agi', rate:0.3 }], proc:85, mp:16, hpCostPct:10, drainIfAil:{ key:'bleed', pct:35 }, desc:'現在HPの10%を払う。相手が出血していれば与えたダメージの35%を吸収。AGIも威力になる' },
  ...
  { name:'毒矢',     cls:'狩人', kind:'phys', mult:1.27, add:[{ stat:'dex', rate:0.5 }], proc:90, mp:12, ail:{ key:'poison', chance:35 }, desc:'DEXが大きく威力になる。35%で毒' },
  ...
  { name:'仕留めの矢', cls:'狩人', kind:'phys', mult:1.41, add:[{ stat:'dex', rate:0.4 }], proc:82, mp:18, lowHpBonus:{ max:45, at:20 }, desc:'とどめの一矢。相手のHPが低いほど威力が上がる（HP20%以下で最大+45%）。DEXも威力になる' },
  { name:'鷹ノ目',   cls:'狩人', kind:'passive', mp:0, passive:{ hitMult:{ mult:1.1, lowMult:1.3, at:30 } }, desc:'命中率が1.1倍。相手のHPが30%以下なら1.3倍' },
  { name:'貫き矢',   cls:'狩人', kind:'phys', mult:1.53, add:[{ stat:'dex', rate:0.3 }], defPen:0.35, proc:88, mp:14, reqJobs:5, desc:'相手の防御を35%無視。DEXも威力になる' },
  { name:'追い討ち', cls:'狩人', kind:'phys', mult:1.27, add:[{ stat:'dex', rate:0.3 }], proc:88, mp:14, lowHpBonus:{ max:50, at:20 }, reqJobs:5, desc:'DEXも威力になる。相手のHPが低いほど威力が上がる（HP20%以下で最大＋50%）' },
  { name:'スモークボム',     cls:'狩人', kind:'phys', mult:1.75, add:[{ stat:'dex', rate:0.3 }], proc:85, mp:16, buff:{ enemy:{ dex:-25 } }, reqJobs:5, desc:'目つぶし。相手のDEX-25%（重ねがけ可）。DEXも威力になる' },
  { name:'鷹爪連射', cls:'狩人', kind:'phys', mult:0.34, add:[{ stat:'dex', rate:0.15 }], hits:4, proc:80, mp:20, noCrit:true, lowHpBonus:{ max:30, at:20 }, reqJobs:5, desc:'4連射。DEXも威力になる。クリティカルしない。相手のHPが低いほど威力が上がる' },
  { name:'トラップセット',   cls:'狩人', kind:'buff', proc:95, mp:13, buff:{ enemy:{ agi:-35 } }, priority:1, reqJobs:5, desc:'相手のAGI-35%（重ねがけ可）' },
  { name:'瞬歩瞬殺', cls:'暗殺者', kind:'phys', mult:1.31, add:[{ stat:'agi', rate:0.4 }], proc:90, mp:12, ail:{ key:'bleed', chance:60 }, desc:'AGIも威力になる。60%で出血' },
  { name:'鬼影閃',   cls:'暗殺者', kind:'phys', mult:0.68, hits:3, proc:85, mp:16, noCrit:true, ail:{ key:'bleed', chance:40 }, desc:'3連撃。40%で出血。クリティカルしない' },
  ...
  { name:'影裂き',   cls:'暗殺者', kind:'phys', mult:0.44, add:[{ stat:'agi', rate:0.2 }], hits:3, proc:85, mp:16, noCrit:true, ail:{ key:'bleed', chance:35 }, ailPerHit:true, desc:'3連撃。クリティカルしない。1発ごとに35%で出血。AGIも威力になる' },
  { name:'隠身',     cls:'暗殺者', kind:'passive', mp:0, passive:{ bleedMax:10, critDmg:10 }, desc:'自分が付ける出血が10スタックまで貯まる。クリティカルダメージ+10%' },
  { name:'背後刺し', cls:'暗殺者', kind:'phys', mult:1.16, add:[{ stat:'agi', rate:0.35 }], hitBonus:10, proc:88, mp:14, consumeAil:{ key:'bleed', perStack:0.12 }, reqJobs:5, desc:'死角から刺す。命中+10%。AGIも威力になる。相手の出血を全部消費して威力が上がる' },
  { name:'毒刃',     cls:'暗殺者', kind:'phys', mult:1.54, add:[{ stat:'agi', rate:0.3 }], proc:88, mp:14, ail:{ key:'poison', chance:40 }, reqJobs:5, desc:'AGIも威力になる。40%で毒' },
  { name:'足首断ち', cls:'暗殺者', kind:'phys', mult:1.77, add:[{ stat:'agi', rate:0.4 }], proc:82, mp:18, ail:{ key:'slow', chance:30 }, reqJobs:5, desc:'AGIも威力になる。30%で鈍足' },
  { name:'千刃乱舞', cls:'暗殺者', kind:'phys', mult:0.393, add:[{ stat:'agi', rate:0.15 }], hits:4, proc:80, mp:20, noCrit:true, ail:{ key:'bleed', chance:45 }, reqJobs:5, desc:'4連撃。45%で出血。AGIも威力になる。クリティカルしない' },
  ...
  { name:'元素連鎖', cls:'元素使い', kind:'mag', mult:1.78, add:[{ stat:'dex', rate:0.3 }], proc:85, mp:17, combo:{ after:['アクアショット', 'アースクエイク', 'スパークショット', 'アイスプリズン'], mult:35 }, desc:'前の元素を引き継いで撃つ。直前が水・地・雷・氷なら威力+35%。DEXも威力になる' },
  ...
  { name:'幽世ノ門',   cls:'死霊使い', kind:'mag', mult:1.86, add:[{ stat:'vit', rate:0.4 }], proc:80, mp:21, buff:{ enemy:{ vit:-20, agi:-20 } }, drain:0.15, desc:'冥府へ引きずり込む。相手のVIT・AGI-20%（重ねがけ可）。与えたダメージの15%を吸収。VITも威力になる' },
  { name:'疫病の手', cls:'死霊使い', kind:'mag', mult:1.83, add:[{ stat:'vit', rate:0.3 }], proc:85, mp:17, ail:{ key:'poison', chance:45 }, buff:{ enemy:{ vit:-15 } }, desc:'45%で毒。相手のVIT-15%（重ねがけ可）。VITも威力になる' },
  { name:'骸の壁',     cls:'死霊使い', kind:'passive', mp:0, passive:{ wall:{ pct:10, every:5 } }, desc:'戦闘開始時と自分の行動5回ごとに「次に受けるダメージ10%減」を得る（重複しない・1回受けると消える）' },
  { name:'カースハンド',   cls:'死霊使い', kind:'mag', mult:1.78, add:[{ stat:'vit', rate:0.3 }], proc:90, mp:13, ail:{ key:'healCut', chance:40, pct:30 }, reqJobs:5, desc:'亡者の手が伸びる。40%で回復阻害（回復量-30%）。VITも威力になる' },
  { name:'コープスポイズン',       cls:'死霊使い', kind:'mag', mult:1.9, add:[{ stat:'vit', rate:0.3 }], proc:85, mp:17, ail:{ key:'poison', chance:50 }, reqJobs:5, desc:'VITも威力になる。50%で毒' },
  { name:'デスウェイル', cls:'死霊使い', kind:'mag', mult:1.8, add:[{ stat:'vit', rate:0.3 }], proc:85, mp:17, buff:{ enemy:{ str:-20, agi:-20 } }, ail:{ key:'healCut', chance:35 }, reqJobs:5, desc:'怯ませる。相手のSTR・AGI-20%（重ねがけ可）。35%で回復阻害。VITも威力になる' },
  { name:'ヘルチェイン',   cls:'死霊使い', kind:'mag', mult:2.06, add:[{ stat:'vit', rate:0.4 }], proc:80, mp:21, ail:{ key:'slow', chance:40 }, reqJobs:5, desc:'鎖で縛りつける。40%で鈍足。VITも威力になる' },
  { name:'ライフコンバート',   cls:'死霊使い', kind:'heal', proc:85, mp:16, heal:{ rate:1.35 }, reqJobs:5, desc:'生命を練り直してHPを戻す' },
  { name:'ホーリーライト', cls:'聖職者', kind:'mag', mult:2.2, proc:90, mp:13, desc:'聖なる光' },
  { name:'奇跡',           cls:'聖職者', kind:'heal', proc:85, mp:18, regen:{ rate:0.9, turns:4 }, desc:'しばらく毎ターンHPが戻る' },
  ...
  { name:'インクイジション',     cls:'異端審問官', kind:'mag', mult:1.78, add:[{ stat:'vit', rate:0.3 }], proc:90, mp:13, buff:{ enemy:{ str:-20 } }, reqJobs:5, desc:'痛めつけて力を奪う。相手のSTR-20%（重ねがけ可）。VITも威力になる' },
  ...
  { name:'ホーリーエッジ',     cls:'聖騎士', kind:'phys', mult:1.36, add:[{ stat:'vit', rate:0.5 }], proc:90, mp:12, buff:{ self:{ vit:15 } }, desc:'VITが大きく威力になる。自分のVIT+15%（重ねがけ可）' },
  { name:'ディバインスマイト', cls:'聖騎士', kind:'phys', mult:2.08, proc:85, mp:16, buff:{ enemy:{ str:-20 } }, desc:'相手のSTR-20%（重ねがけ可）' },
  { name:'聖域展開',           cls:'聖騎士', kind:'heal', proc:85, mp:18, regen:{ rate:0.9, turns:4 }, desc:'聖域を敷いて、しばらく毎ターンHPが戻る' },
  { name:'神聖覚醒',           cls:'聖騎士', kind:'phys', mult:1.75, add:[{ stat:'vit', rate:0.6 }], proc:80, mp:20, desc:'VITも大きく威力になる。VITが大きく威力になる' },
  ...
  { name:'シールドバッシュ',     cls:'聖騎士', kind:'phys', mult:1.39, add:[{ stat:'vit', rate:0.4 }], proc:90, mp:12, ail:{ key:'paralyze', chance:8 }, reqJobs:5, desc:'VITも威力になる。8%で麻痺' },
  { name:'ジャッジメントブロウ', cls:'聖騎士', kind:'phys', mult:1.6, add:[{ stat:'vit', rate:0.6 }], proc:85, mp:16, reqJobs:5, desc:'裁きの一撃。VITが大きく威力になる' },
  { name:'ラストガード',         cls:'聖騎士', kind:'phys', mult:1.67, add:[{ stat:'vit', rate:0.5 }], proc:82, mp:18, buff:{ self:{ vit:20 } }, reqJobs:5, desc:'守りを固めながら殴る。VITが大きく威力になる・自分のVIT+20%（重ねがけ可）' },
  { name:'オースシールド',             cls:'聖騎士', kind:'buff', proc:100, mp:13, buff:{ self:{ vit:50 } }, priority:1, reqJobs:5, desc:'VIT+50%（重ねがけ可）' },
  { name:'ホーリーケア',           cls:'聖騎士', kind:'heal', proc:85, mp:16, heal:{ rate:1.35 }, reqJobs:5, desc:'祈りでHPを戻す' },
  { name:'雷光斬',           cls:'魔法剣士', kind:'phys', mult:1.23, add:[{ stat:'int_stat', rate:0.6 }], proc:90, mp:12, ail:{ key:'paralyze', chance:6 }, desc:'INTが大きく威力になる。6%で麻痺' },
  ...
  { name:'エレメンタルエッジ', cls:'魔法剣士', kind:'phys', mult:1.14, add:[{ stat:'int_stat', rate:0.9 }], proc:80, mp:20, switchKind:25, desc:'両刀の切り札。直前に魔法を使っていれば威力+25%。INTが大きく威力になる' },
  { name:'双極斬',   cls:'魔法剣士', kind:'phys', mult:1.31, add:[{ stat:'int_stat', rate:0.5 }], proc:85, mp:16, switchKind:35, desc:'INTが大きく威力になる。直前に魔法を使っていれば威力+35%' },
  ...
  { name:'天魔閃',       cls:'魔法剣士', kind:'phys', mult:1.19, add:[{ stat:'int_stat', rate:0.8 }], proc:80, mp:20, switchKind:30, reqJobs:5, desc:'INTも大きく威力になる。直前に魔法を使っていれば威力+30%。INTが大きく威力になる' },
  { name:'ソードオーラ',     cls:'魔法剣士', kind:'buff', proc:100, mp:15, buff:{ self:{ agi:30, str:30 } }, priority:1, reqJobs:5, desc:'AGI+30%・STR+30%（重ねがけ可）' },
  { name:'魔弾',                   cls:'魔銃士', kind:'phys', mult:1.41, add:[{ stat:'dex', rate:0.6 }], proc:85, mp:16, repeat:{ per:6, max:3 }, desc:'DEXが大きく威力になる。同じ技を続けて撃つほど威力+6%（3回まで）' },
  ...
  { name:'半月蹴り',     cls:'体術師', kind:'phys', mult:1.54, add:[{ stat:'agi', rate:0.3 }], proc:90, mp:12, airUp:true, desc:'足を払って跳び上がる。空中へ（空中のあいだ回避+10%）。AGIも威力になる' },
  { name:'五連殺',       cls:'体術師', kind:'phys', mult:0.25, add:[{ stat:'agi', rate:0.12 }], hits:5, proc:80, mp:20, noCrit:true, keepAir:true, whileAir:{ mult:25 }, whileGround:{ mult:10 }, desc:'5連撃。クリティカルしない。空中なら威力+25%・地上なら+10%。蹴り続けるので位置は変わらない。AGIも威力になる' },
  { name:'破衝掌',       cls:'体術師', kind:'phys', mult:1.53, defPen:0.5, proc:85, mp:16, whileAir:{ mult:40 }, desc:'相手の防御を50%無視。空中なら威力+40%（叩きつけて着地）' },
  { name:'飛天三角蹴り', cls:'体術師', kind:'phys', mult:0.37, add:[{ stat:'agi', rate:0.15 }], hits:3, proc:78, mp:22, noCrit:true, airUp:true, keepAir:true, rampHit:35, whileAir:{ hitBonus:20 }, desc:'3連撃。クリティカルしない。踏み込むほど鋭くなる（2発目から1発ごとに威力+35%）。空中なら命中+20%。跳び上がってそのまま空中に留まる。AGIも威力になる' },
  ...
  { name:'ウィスプ', cls:'精霊召喚士', kind:'mag', mult:1.51, add:[{ stat:'agi', rate:0.3 }], proc:90, mp:13, repeat:{ per:14, max:3 }, desc:'小さな光の精霊。同じ技を続けて呼ぶほど威力+14%（3回まで）。AGIも威力になる' },
  ...
  { name:'式神・鬼', cls:'式神使い', kind:'mag', mult:1.71, add:[{ stat:'dex', rate:0.3 }], proc:85, mp:17, ritual:1, whileStack:{ key:'ritual', mult:20 }, desc:'撃ちながら呪力+1。呪力があるあいだ威力+20%。DEXも威力になる' },
  ...
  { name:'封印符',     cls:'式神使い', kind:'mag', mult:1.78, add:[{ stat:'dex', rate:0.3 }], proc:88, mp:15, ail:{ key:'silence', chance:35 }, whileStack:{ key:'ritual', ailChance:25 }, reqJobs:5, desc:'口を封じる。35%でサイレンス（発動率-20%）。呪力があるあいだ、さらに+25%。DEXも威力になる' },
  { name:'大祓',       cls:'式神使い', kind:'heal', proc:85, mp:16, heal:{ rate:1.35 }, reqJobs:5, desc:'穢れを祓ってHPを戻す' },
  { name:'練気掌',       cls:'武僧', kind:'phys', mult:1.78, add:[{ stat:'vit', rate:0.3 }], proc:85, mp:16, cure:1, desc:'気を練りながら打つ。自分の状態異常を1つ払う。VITも威力になる' },
  { name:'活殺自在',     cls:'武僧', kind:'phys', mult:1.46, add:[{ stat:'vit', rate:0.3 }], proc:85, mp:16, drain:0.4, cure:1, desc:'与えたダメージの40%を吸収。自分の状態異常を1つ払う。VITも威力になる' },
  ...
  { name:'気功掌',     cls:'武僧', kind:'phys', mult:1.53, add:[{ stat:'vit', rate:0.3 }], proc:90, mp:12, cure:1, reqJobs:5, desc:'気を乗せた掌底。VITも威力になる。自分の状態異常を1つ払う' },
  { name:'三連震脚',   cls:'武僧', kind:'phys', mult:0.58, add:[{ stat:'vit', rate:0.15 }], hits:3, proc:85, mp:16, noCrit:true, reqJobs:5, desc:'3連撃。VITも威力になる。クリティカルしない' },
  { name:'破戒撃',       cls:'武僧', kind:'phys', mult:1.66, add:[{ stat:'vit', rate:0.3 }], proc:85, mp:16, buff:{ enemy:{ vit:-20 } }, ail:{ key:'silence', chance:30 }, reqJobs:5, desc:'相手のVIT-20%（重ねがけ可）。30%でサイレンス（発動率-20%）。VITも威力になる' },
  { name:'自癒功',     cls:'武僧', kind:'heal', proc:85, mp:15, heal:{ rate:1.3 }, cure:2, reqJobs:5, desc:'気で傷を塞ぐ。自分の状態異常を2つ払う' },
  { name:'阿吽の呼吸', cls:'武僧', kind:'buff', proc:100, mp:15, buff:{ self:{ vit:30, str:30 } }, priority:1, reqJobs:5, desc:'VIT+30%・STR+30%（重ねがけ可）' },
  { name:'ホークダイブ',   cls:'ビーストレンジャー', kind:'phys', mult:1.34, add:[{ stat:'agi', rate:0.3 }], proc:90, mp:12, form:'hawk', desc:'鷹が急降下する。AGIも威力になる。鷹を呼ぶ（AGI+20%・DEX+15%）。すでに鷹なら威力+25%' },
  { name:'ベアクロー',   cls:'ビーストレンジャー', kind:'phys', mult:1.43, add:[{ stat:'agi', rate:0.3 }], proc:88, mp:14, form:'bear', desc:'AGIも威力になる。熊を呼ぶ（STR+20%・VIT+20%）。すでに熊なら威力+25%' },
  { name:'バイパーアロー',   cls:'ビーストレンジャー', kind:'phys', mult:1.36, add:[{ stat:'agi', rate:0.3 }], proc:85, mp:16, ail:{ key:'poison', chance:45 }, form:'snake', desc:'AGIも威力になる。45%で毒。蛇を呼ぶ（DEX+15%・LUK+15%）。すでに蛇なら威力+25%' },
  ...
  { name:'獣王の咆哮', cls:'ビーストレンジャー', kind:'phys', mult:1.55, add:[{ stat:'agi', rate:0.35 }], proc:82, mp:18, whileForm:{ mult:30 }, desc:'連れている獣と一緒に吼えかかる。獣を連れていれば威力+30%。AGIも威力になる' },
  { name:'野性の勘',   cls:'ビーストレンジャー', kind:'passive', mp:0, passive:{ formBoost:50 }, desc:'獣の扱いに長けている。獣の型によるステータス補正が1.5倍になる' },
  { name:'ワイルドラッシュ',   cls:'ビーストレンジャー', kind:'phys', mult:0.53, add:[{ stat:'agi', rate:0.15 }], hits:3, proc:80, mp:20, noCrit:true, whileForm:{ mult:20 }, reqJobs:5, desc:'3連撃。AGIも威力になる。クリティカルしない。獣を連れていれば威力+20%' },
  { name:'獣呼びの矢', cls:'ビーストレンジャー', kind:'phys', mult:1.23, add:[{ stat:'agi', rate:0.5 }], proc:90, mp:12, whileForm:{ mult:18 }, reqJobs:5, desc:'AGIが大きく威力になる。獣を連れていれば威力+18%' },
  { name:'狼牙連撃',   cls:'ビーストレンジャー', kind:'phys', mult:0.45, add:[{ stat:'agi', rate:0.2 }], hits:3, proc:85, mp:16, noCrit:true, whileForm:{ mult:18 }, reqJobs:5, desc:'3連撃。クリティカルしない。獣を連れていれば威力+18%。AGIも威力になる' },
...
export const powerText = (s) => {
  ...
  if (s.kind === 'heal') {
    // ★何がどれだけ戻るかは**ここだけ**が出す（説明文に数字を書くと片方だけ古くなる）
    if (s.mpRegen) return `毎ターン MPを INT×${s.mpRegen.rate} 回復 ×${s.mpRegen.turns}T`
    if (s.regen)   return `毎ターン HPを INT×${s.regen.rate} 回復 ×${s.regen.turns}T`
    return `HPを INT×${s.heal?.rate || 0} 回復`
  }
