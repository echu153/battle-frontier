-- ============================================================
-- ⚠⚠⚠ 【廃止・実行禁止】このファイルは supabase_zeni_bank.sql に置き換わりました。
--   後から流すと dungeon_finish が旧仕様（zeni_run/2ロスト）に巻き戻り、
--   ゼニ倉庫（任意預け入れ）が機能しなくなります。適用しないでください。
-- ============================================================
-- ゼニの戦闘不能ロスト（2026-07-07・旧仕様）
