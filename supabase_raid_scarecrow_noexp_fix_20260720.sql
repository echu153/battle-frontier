...
-- ============================================================
-- ⚠ 2026-08-02: このファイルの仕様（かかし修練中はレイド出撃報酬EXPなし）は
--    ユーザー指示で【撤回】されました。修練中でもEXPは入ります。
--    attack_raid_boss の「最後に流す正」は
--    【supabase_raid_update_20260802.sql】（出撃回数EXPボーナス入り・修練中も付与）です。
--    このファイルを後から流すとボーナスが消え、修練中EXPなしに逆戻りします。実行非推奨。
-- ============================================================
