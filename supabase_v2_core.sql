...
insert into public.v2_skills (name, cls, mp, sort, req_jobs) values
  ...
  ('毒矢','狩人',12,1,0), ('三連射','狩人',16,2,0), ('鷹ノ目','狩人',0,3,0), ('狩猟本能','狩人',14,4,0), ('絶影狙撃','狩人',20,5,0), ('貫き矢','狩人',14,6,0), ('追い討ち','狩人',14,7,0), ('スモークボム','狩人',16,8,0), ('鷹爪連射','狩人',20,9,0), ('トラップセット','狩人',13,10,0),
  ...
  ('アクアショット','元素使い',13,1,0), ('アースクエイク','元素使い',17,2,0), ('元素共鳴','元素使い',0,3,0), ('ライトニングボルト','元素使い',17,4,0), ('フレイムバースト','元素使い',21,5,0), ('スパークショット','元素使い',13,6,0), ('アイスプリズン','元素使い',17,7,0), ('マグマフィスト','元素使い',17,8,0), ('エレメンタルレイン','元素使い',23,9,0), ('エレメントチャージ','元素使い',14,10,0),
  ('骸骨召喚','死霊使い',13,1,0), ('ソウルドレイン','死霊使い',17,2,0), ('骸の壁','死霊使い',0,3,0), ('腐敗霧','死霊使い',17,4,0), ('幽世ノ門','死霊使い',21,5,0), ('カースハンド','死霊使い',13,6,0), ('コープスポイズン','死霊使い',17,7,0), ('デスウェイル','死霊使い',17,8,0), ('ヘルチェイン','死霊使い',21,9,0), ('ライフコンバート','死霊使い',16,10,0),
  ('ホーリーライト','聖職者',13,1,0), ('奇跡','聖職者',18,2,0), ('神聖加護','聖職者',0,3,0), ('祈りの結界','聖職者',14,4,0), ('神罰執行','聖職者',21,5,0), ('セイントレイ','聖職者',13,6,0), ('ピュリファイ','聖職者',17,7,0), ('ジャッジライト','聖職者',17,8,0), ('メガヒール','聖職者',20,9,0), ('グレイスウィンド','聖職者',12,10,0),
  ('粛清','異端審問官',13,1,0), ('狂信','異端審問官',12,2,0), ('執行本能','異端審問官',0,3,0), ('聖なる裁き','異端審問官',17,4,0), ('断罪','異端審問官',21,5,0), ('インクイジション','異端審問官',13,6,0), ('アイアンメイデン','異端審問官',17,7,0), ('ヘレティックハント','異端審問官',17,8,0), ('サイレンスチェイン','異端審問官',15,9,0), ('火刑','異端審問官',21,10,0),
  ...
  ('ホーリーエッジ','聖騎士',12,1,0), ('ディバインスマイト','聖騎士',16,2,0), ('聖騎士の心得','聖騎士',0,3,0), ('聖域展開','聖騎士',18,4,0), ('神聖覚醒','聖騎士',20,5,0), ('シールドバッシュ','聖騎士',12,6,0), ('ジャッジメントブロウ','聖騎士',16,7,0), ('ラストガード','聖騎士',18,8,0), ('オースシールド','聖騎士',13,9,0), ('ホーリーケア','聖騎士',16,10,0),
  ('雷光斬','魔法剣士',12,1,0), ('閃光','魔法剣士',12,2,0), ('魔導剣術','魔法剣士',0,3,0), ('魔剣開放','魔法剣士',18,4,0), ('エレメンタルエッジ','魔法剣士',20,5,0), ('マナエッジ','魔法剣士',12,6,0), ('フロストエッジ','魔法剣士',14,7,0), ('マナバースト','魔法剣士',17,8,0), ('天魔閃','魔法剣士',20,9,0), ('ソードオーラ','魔法剣士',15,10,0),
  ('魔弾','魔銃士',16,1,0), ('連装銃撃','魔銃士',16,2,0), ('精密照準','魔銃士',0,3,0), ('強化装填','魔銃士',16,4,0), ('キャノネスチュームビンド','魔銃士',20,5,0), ('ラピッドショット','魔銃士',11,6,0), ('ピアースバレット','魔銃士',14,7,0), ('バーストショット','魔銃士',16,8,0), ('フルバースト','魔銃士',22,9,0), ('トレーサーロード','魔銃士',14,10,0),
  ('サイコショット','サイキッカー',13,1,0), ('マインドブレイク','サイキッカー',17,2,0), ('第六感','サイキッカー',0,3,0), ('精神集中','サイキッカー',16,4,0), ('サイコブラスト','サイキッカー',21,5,0), ('テレキネシス','サイキッカー',13,6,0), ('サイコノイズ','サイキッカー',15,7,0), ('マインドスパイク','サイキッカー',17,8,0), ('サイキックチェイン','サイキッカー',20,9,0), ('マインドアクセル','サイキッカー',15,10,0),
  ...
  ('ジャグリング','ギャンブラー',16,1,0), ('ラッキーダイス','ギャンブラー',16,2,0), ('ギャンブルボディ','ギャンブラー',0,3,0), ('オールイン','ギャンブラー',18,4,0), ('ジャックポット','ギャンブラー',22,5,0), ('コイントス','ギャンブラー',12,6,0), ('カードスロー','ギャンブラー',16,7,0), ('ラストベット','ギャンブラー',20,8,0), ('イカサマ','ギャンブラー',13,9,0), ('レディラック','ギャンブラー',14,10,0),
  ('ドラゴンスラスト','竜騎士',12,1,0), ('ドラゴンファング','竜騎士',16,2,0), ('竜鱗の加護','竜騎士',0,3,0), ('ドラゴンロア','竜騎士',14,4,0), ('天墜竜閃','竜騎士',22,5,0), ('ランスチャージ','竜騎士',12,6,0), ('スケイルピアス','竜騎士',14,7,0), ('ドラゴンダイブ','竜騎士',18,8,0), ('インティミデイト','竜騎士',14,9,0), ('ドラゴンブラッド','竜騎士',15,10,0),
  ...
  ('獣呼びの矢','ビーストレンジャー',12,1,0), ('群狼の牙','ビーストレンジャー',17,2,0), ('野性の勘','ビーストレンジャー',0,3,0), ('共鳴の咆哮','ビーストレンジャー',14,4,0), ('貫狼撃','ビーストレンジャー',18,5,0), ('ホークダイブ','ビーストレンジャー',12,6,0), ('ベアクロー','ビーストレンジャー',14,7,0), ('バイパーアロー','ビーストレンジャー',16,8,0), ('ワイルドラッシュ','ビーストレンジャー',20,9,0), ('ビーストコール','ビーストレンジャー',14,10,0);
