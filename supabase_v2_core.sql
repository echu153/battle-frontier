...
insert into public.v2_materials (id, name, enemy, area, tier, rarity, is_boss, stats, lo, hi) values
  ...
  ('mr:1:1:n', '古木の樹皮', '古木のトレント', 1, 1, 'normal', false, array['hp'], 0.2, 1.5),
  ('mr:1:1:r', '年輪の芯材', '古木のトレント', 1, 1, 'rare', false, array['hp'], 0.5, 1.5),
  ('mr:1:1:u', 'トレントの樹心', '古木のトレント', 1, 1, 'ultra', false, array['hp'], 0.8, 1.5),
  ...
  ('mr:2:2:n', '朝靄の粘液', '朝靄のオオワーム', 2, 2, 'normal', false, array['hp'], 0.2, 1.5),
  ('mr:2:2:r', 'オオワームの環節', '朝靄のオオワーム', 2, 2, 'rare', false, array['hp'], 0.5, 1.5),
  ('mr:2:2:u', 'オオワームの顎骨', '朝靄のオオワーム', 2, 2, 'ultra', false, array['hp'], 0.8, 1.5),
  ...
  ('mr:2:4:n', '影渡りの外套', '影渡りの盗賊王', 2, 2, 'normal', false, array['luk'], 0.2, 1.5),
  ('mr:2:4:r', '盗賊王の暗器', '影渡りの盗賊王', 2, 2, 'rare', false, array['luk'], 0.5, 1.5),
  ('mr:2:4:u', '盗賊王の秘符', '影渡りの盗賊王', 2, 2, 'ultra', false, array['luk'], 0.8, 1.5),
  ...
  ('mr:4:2:n', 'セイレーン姫の鱗', '朝凪のセイレーン姫', 4, 4, 'normal', false, array['int_stat'], 0.2, 2),
  ('mr:4:2:r', 'セイレーンの歌片', '朝凪のセイレーン姫', 4, 4, 'rare', false, array['int_stat'], 0.6, 2),
  ('mr:4:2:u', 'セイレーン姫の宝冠', '朝凪のセイレーン姫', 4, 4, 'ultra', false, array['int_stat'], 1, 2),
  ...
  ('mr:6:3:n', 'アイスドライアドの氷片', '白光のアイスドライアド', 6, 6, 'normal', false, array['int_stat'], 0.2, 2.4),
  ('mr:6:3:r', '氷華の枝晶', '白光のアイスドライアド', 6, 6, 'rare', false, array['int_stat'], 0.8, 2.4),
  ('mr:6:3:u', 'アイスドライアドの氷冠', '白光のアイスドライアド', 6, 6, 'ultra', false, array['int_stat'], 1.2, 2.4),
  ...
  ('mr:7:2:n', '暁炎の翼膜', '暁炎の大フレイムバット', 7, 7, 'normal', false, array['str'], 0.2, 3),
  ('mr:7:2:r', '大フレイムバットの爪', '暁炎の大フレイムバット', 7, 7, 'rare', false, array['str'], 0.9, 3),
  ('mr:7:2:u', '大フレイムバットの火心', '暁炎の大フレイムバット', 7, 7, 'ultra', false, array['str'], 1.5, 3),
  ...
  ('mr:9:2:n', '大砂トカゲの砂鱗', '陽炎の大砂トカゲ', 9, 4, 'normal', false, array['int_stat'], 0.2, 2),
  ('mr:9:2:r', '大砂トカゲの熱鱗', '陽炎の大砂トカゲ', 9, 4, 'rare', false, array['int_stat'], 0.6, 2),
  ('mr:9:2:u', '大砂トカゲの灼核', '陽炎の大砂トカゲ', 9, 4, 'ultra', false, array['int_stat'], 1, 2),
  ...
  ('mr:10:0:n', '樹海の樹皮', '樹海の大食人樹', 10, 5, 'normal', false, array['hp'], 0.2, 2.4),
  ('mr:10:0:r', '大食人樹の顎木', '樹海の大食人樹', 10, 5, 'rare', false, array['hp'], 0.8, 2.4),
  ('mr:10:0:u', '大食人樹の樹心', '樹海の大食人樹', 10, 5, 'ultra', false, array['hp'], 1.2, 2.4),
  ('mr:10:1:n', '毒霧の根片', '毒霧のマンドラゴラ女王', 10, 5, 'normal', false, array['int_stat'], 0.2, 2.4),
  ('mr:10:1:r', 'マンドラゴラ女王の葉', '毒霧のマンドラゴラ女王', 10, 5, 'rare', false, array['int_stat'], 0.8, 2.4),
  ('mr:10:1:u', 'マンドラゴラ女王の毒核', '毒霧のマンドラゴラ女王', 10, 5, 'ultra', false, array['int_stat'], 1.2, 2.4),
  ...
  ('mr:10:4:n', 'バンシーの哭布', '常闇のバンシー女王', 10, 5, 'normal', false, array['int_stat'], 0.2, 2.4),
  ('mr:10:4:r', 'バンシー女王の涙晶', '常闇のバンシー女王', 10, 5, 'rare', false, array['int_stat'], 0.8, 2.4),
  ('mr:10:4:u', 'バンシー女王の呪核', '常闇のバンシー女王', 10, 5, 'ultra', false, array['int_stat'], 1.2, 2.4),
  ('mr:11:0:n', '雷翼の羽根', '雷翼の嵐鷲', 11, 6, 'normal', false, array['agi'], 0.2, 2.4),
  ('mr:11:0:r', '嵐鷲の嘴', '雷翼の嵐鷲', 11, 6, 'rare', false, array['agi'], 0.8, 2.4),
  ('mr:11:0:u', '嵐鷲の雷核', '雷翼の嵐鷲', 11, 6, 'ultra', false, array['agi'], 1.2, 2.4),
  ...
  ('mr:12:2:n', '朝霞の鬼火片', '朝霞の大ウィルオウィスプ', 12, 7, 'normal', false, array['mp'], 0.2, 3),
  ('mr:12:2:r', '大ウィルオウィスプの灯芯', '朝霞の大ウィルオウィスプ', 12, 7, 'rare', false, array['mp'], 0.9, 3),
  ('mr:12:2:u', '大ウィルオウィスプの霊核', '朝霞の大ウィルオウィスプ', 12, 7, 'ultra', false, array['mp'], 1.5, 3),
  ...
  ('mr:12:4:n', '夜霧の腐肉', '夜霧のグレーターゾンビ', 12, 7, 'normal', false, array['str'], 0.2, 3),
  ('mr:12:4:r', 'グレーターゾンビの朽骨', '夜霧のグレーターゾンビ', 12, 7, 'rare', false, array['str'], 0.9, 3),
  ('mr:12:4:u', 'グレーターゾンビの疫核', '夜霧のグレーターゾンビ', 12, 7, 'ultra', false, array['str'], 1.5, 3),
  ...
  ('mr:13:2:n', '曙光の晶殻', '曙光の大クリスタルワーム', 13, 7, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:13:2:r', '大クリスタルワームの晶角', '曙光の大クリスタルワーム', 13, 7, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:13:2:u', '大クリスタルワームの輝核', '曙光の大クリスタルワーム', 13, 7, 'ultra', false, array['int_stat'], 1.5, 3),
  ...
  ('mr:13:4:n', '深穴の影片', '深穴のグレーターシャドウ', 13, 7, 'normal', false, array['agi'], 0.2, 3),
  ('mr:13:4:r', 'グレーターシャドウの暗衣', '深穴のグレーターシャドウ', 13, 7, 'rare', false, array['agi'], 0.9, 3),
  ('mr:13:4:u', 'グレーターシャドウの虚核', '深穴のグレーターシャドウ', 13, 7, 'ultra', false, array['agi'], 1.5, 3),
  ...
  ('mr:14:3:n', '白日の獅毛', '白日のスフィンクス王', 14, 8, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:14:3:r', 'スフィンクス王の謎符', '白日のスフィンクス王', 14, 8, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:14:3:u', 'スフィンクス王の白日核', '白日のスフィンクス王', 14, 8, 'ultra', false, array['int_stat'], 1.5, 3),
  ('mr:14:4:n', 'ルナウルフ王の月毛', '星宿のルナウルフ王', 14, 8, 'normal', false, array['mp'], 0.2, 3),
  ('mr:14:4:r', 'ルナウルフ王の月衣', '星宿のルナウルフ王', 14, 8, 'rare', false, array['mp'], 0.9, 3),
  ('mr:14:4:u', 'ルナウルフ王の宿星核', '星宿のルナウルフ王', 14, 8, 'ultra', false, array['mp'], 1.5, 3),
  ...
  ('mr:15:4:n', '深海の鱗片', '深海のセイレーン女帝', 15, 8, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:15:4:r', 'セイレーン女帝の歌晶', '深海のセイレーン女帝', 15, 8, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:15:4:u', 'セイレーン女帝の深冠', '深海のセイレーン女帝', 15, 8, 'ultra', false, array['int_stat'], 1.5, 3)
on conflict (id) do update set
