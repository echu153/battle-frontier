...
insert into public.v2_materials (id, name, enemy, area, tier, rarity, is_boss, stats, lo, hi) values
  ...
  ('m:14:1:n', '守護機構の装甲', '遺跡守護機構', 14, 8, 'normal', false, array['vit'], 0.1, 2),
  ('m:14:1:r', '古代の歯車', '遺跡守護機構', 14, 8, 'rare', false, array['vit'], 0.6, 2),
  ('m:14:1:u', '不朽の駆動核', '遺跡守護機構', 14, 8, 'ultra', false, array['vit'], 1, 2),
  ...
  ('m:14:5:n', '月光の裾布', '星宿のルナリス', 14, 8, 'normal', false, array['luk'], 0.1, 2),
  ('m:14:5:r', '星宿の耳飾り', '星宿のルナリス', 14, 8, 'rare', false, array['luk'], 0.6, 2),
  ('m:14:5:u', 'ルナリスの月華石', '星宿のルナリス', 14, 8, 'ultra', false, array['luk'], 1, 2),
  ...
  ('m:15:5:n', '女王の鱗衣', '深海のセイレーン女王', 15, 8, 'normal', false, array['mp'], 0.1, 2),
  ('m:15:5:r', '蒼海の宝冠', '深海のセイレーン女王', 15, 8, 'rare', false, array['mp'], 0.6, 2),
  ('m:15:5:u', '魅惑の歌声', '深海のセイレーン女王', 15, 8, 'ultra', false, array['mp'], 1, 2),
  ...
  ('mr:1:0:n', '翠玉の粘塊', '翠玉のスライムロード', 1, 1, 'normal', false, array['vit'], 0.2, 1.5),
  ('mr:1:0:r', '王核の結晶膜', '翠玉のスライムロード', 1, 1, 'rare', false, array['vit'], 0.5, 1.5),
  ('mr:1:0:u', '翠玉王の芯核', '翠玉のスライムロード', 1, 1, 'ultra', false, array['vit'], 0.8, 1.5),
  ('mr:1:1:n', '古木の樹皮', '古木の番人フォレスト', 1, 1, 'normal', false, array['hp'], 0.2, 1.5),
  ('mr:1:1:r', '年輪の芯材', '古木の番人フォレスト', 1, 1, 'rare', false, array['hp'], 0.5, 1.5),
  ('mr:1:1:u', '番人の樹心', '古木の番人フォレスト', 1, 1, 'ultra', false, array['hp'], 0.8, 1.5),
  ('mr:1:2:n', '暁光の鱗粉', '暁光の妖精女王', 1, 1, 'normal', false, array['mp'], 0.2, 1.5),
  ('mr:1:2:r', '女王の羽衣', '暁光の妖精女王', 1, 1, 'rare', false, array['mp'], 0.5, 1.5),
  ('mr:1:2:u', '妖精女王の王冠', '暁光の妖精女王', 1, 1, 'ultra', false, array['mp'], 0.8, 1.5),
  ('mr:1:3:n', '陽輪の鱗', '陽輪の大トカゲ', 1, 1, 'normal', false, array['str'], 0.2, 1.5),
  ('mr:1:3:r', '灼けた尾芯', '陽輪の大トカゲ', 1, 1, 'rare', false, array['str'], 0.5, 1.5),
  ('mr:1:3:u', '大トカゲの日輪核', '陽輪の大トカゲ', 1, 1, 'ultra', false, array['str'], 0.8, 1.5),
  ('mr:1:4:n', '月冠の羽根', '月冠のフクロウ王', 1, 1, 'normal', false, array['dex'], 0.2, 1.5),
  ('mr:1:4:r', '無音の風切羽', '月冠のフクロウ王', 1, 1, 'rare', false, array['dex'], 0.5, 1.5),
  ('mr:1:4:u', 'フクロウ王の月眼', '月冠のフクロウ王', 1, 1, 'ultra', false, array['dex'], 0.8, 1.5),
  ('mr:2:0:n', '鬼火の牙', '鬼火のゴブリンキング', 2, 2, 'normal', false, array['str'], 0.2, 1.5),
  ('mr:2:0:r', '王の棍棒片', '鬼火のゴブリンキング', 2, 2, 'rare', false, array['str'], 0.5, 1.5),
  ('mr:2:0:u', 'ゴブリン王の冠', '鬼火のゴブリンキング', 2, 2, 'ultra', false, array['str'], 0.8, 1.5),
  ('mr:2:1:n', '銀牙の毛皮', '銀牙のフェンリル', 2, 2, 'normal', false, array['agi'], 0.2, 1.5),
  ('mr:2:1:r', '疾風の爪', '銀牙のフェンリル', 2, 2, 'rare', false, array['agi'], 0.5, 1.5),
  ('mr:2:1:u', 'フェンリルの心臓', '銀牙のフェンリル', 2, 2, 'ultra', false, array['agi'], 0.8, 1.5),
  ('mr:2:2:n', '朝靄の粘液', '朝靄の大地喰らい', 2, 2, 'normal', false, array['hp'], 0.2, 1.5),
  ('mr:2:2:r', '大地喰らいの環節', '朝靄の大地喰らい', 2, 2, 'rare', false, array['hp'], 0.5, 1.5),
  ('mr:2:2:u', '地喰らいの顎骨', '朝靄の大地喰らい', 2, 2, 'ultra', false, array['hp'], 0.8, 1.5),
  ('mr:2:3:n', '灼陽の鱗', '灼陽のバジリスク', 2, 2, 'normal', false, array['str'], 0.2, 1.5),
  ('mr:2:3:r', '石化の毒牙', '灼陽のバジリスク', 2, 2, 'rare', false, array['str'], 0.5, 1.5),
  ('mr:2:3:u', 'バジリスクの邪眼', '灼陽のバジリスク', 2, 2, 'ultra', false, array['str'], 0.8, 1.5),
  ('mr:2:4:n', '影渡りの外套', '影渡りの首領', 2, 2, 'normal', false, array['luk'], 0.2, 1.5),
  ('mr:2:4:r', '首領の暗器', '影渡りの首領', 2, 2, 'rare', false, array['luk'], 0.5, 1.5),
  ('mr:2:4:u', '影首領の秘符', '影渡りの首領', 2, 2, 'ultra', false, array['luk'], 0.8, 1.5),
  ('mr:3:0:n', '黒曜の毛皮', '黒曜のコボルト長', 3, 3, 'normal', false, array['str'], 0.2, 2),
  ('mr:3:0:r', '長の黒曜牙', '黒曜のコボルト長', 3, 3, 'rare', false, array['str'], 0.6, 2),
  ('mr:3:0:u', 'コボルト長の角冠', '黒曜のコボルト長', 3, 3, 'ultra', false, array['str'], 1, 2),
  ('mr:3:1:n', '骸將の骨片', '骸將スケルトンナイト', 3, 3, 'normal', false, array['vit'], 0.2, 2),
  ('mr:3:1:r', '朽ちぬ胸甲', '骸將スケルトンナイト', 3, 3, 'rare', false, array['vit'], 0.6, 2),
  ('mr:3:1:u', '骸將の頭蓋冠', '骸將スケルトンナイト', 3, 3, 'ultra', false, array['vit'], 1, 2),
  ('mr:3:2:n', '曙の石片', '曙の石翼ガーゴイル', 3, 3, 'normal', false, array['vit'], 0.2, 2),
  ('mr:3:2:r', '石翼の欠片', '曙の石翼ガーゴイル', 3, 3, 'rare', false, array['vit'], 0.6, 2),
  ('mr:3:2:u', '石翼王の魔眼', '曙の石翼ガーゴイル', 3, 3, 'ultra', false, array['vit'], 1, 2),
  ('mr:3:3:n', '岩喰いの鱗', '岩喰いバジリスク', 3, 3, 'normal', false, array['vit'], 0.2, 2),
  ('mr:3:3:r', '岩砕きの顎', '岩喰いバジリスク', 3, 3, 'rare', false, array['vit'], 0.6, 2),
  ('mr:3:3:u', '岩喰いの不動核', '岩喰いバジリスク', 3, 3, 'ultra', false, array['vit'], 1, 2),
  ('mr:3:4:n', '冥闇の残滓', '冥闇のレイスロード', 3, 3, 'normal', false, array['int_stat'], 0.2, 2),
  ('mr:3:4:r', '怨嗟の帳', '冥闇のレイスロード', 3, 3, 'rare', false, array['int_stat'], 0.6, 2),
  ('mr:3:4:u', 'レイス王の魂核', '冥闇のレイスロード', 3, 3, 'ultra', false, array['int_stat'], 1, 2),
  ('mr:4:0:n', '珊瑚の甲片', '珊瑚甲のシーナイト', 4, 4, 'normal', false, array['vit'], 0.2, 2),
  ('mr:4:0:r', '海騎士の胸鎧', '珊瑚甲のシーナイト', 4, 4, 'rare', false, array['vit'], 0.6, 2),
  ('mr:4:0:u', 'シーナイトの海心', '珊瑚甲のシーナイト', 4, 4, 'ultra', false, array['vit'], 1, 2),
  ('mr:4:1:n', '渦潮の触手', '渦潮のクラーケン仔', 4, 4, 'normal', false, array['str'], 0.2, 2),
  ('mr:4:1:r', '吸盤の芯', '渦潮のクラーケン仔', 4, 4, 'rare', false, array['str'], 0.6, 2),
  ('mr:4:1:u', 'クラーケンの渦核', '渦潮のクラーケン仔', 4, 4, 'ultra', false, array['str'], 1, 2),
  ('mr:4:2:n', '海妖姫の鱗', '朝凪の海妖姫', 4, 4, 'normal', false, array['int_stat'], 0.2, 2),
  ('mr:4:2:r', '海妖の歌片', '朝凪の海妖姫', 4, 4, 'rare', false, array['int_stat'], 0.6, 2),
  ('mr:4:2:u', '海妖姫の宝冠', '朝凪の海妖姫', 4, 4, 'ultra', false, array['int_stat'], 1, 2),
  ('mr:4:3:n', '潮鳴りの甲殻', '潮鳴りの巨蟹', 4, 4, 'normal', false, array['vit'], 0.2, 2),
  ('mr:4:3:r', '巨蟹の鋏', '潮鳴りの巨蟹', 4, 4, 'rare', false, array['vit'], 0.6, 2),
  ('mr:4:3:u', '巨蟹王の海甲', '潮鳴りの巨蟹', 4, 4, 'ultra', false, array['vit'], 1, 2),
  ('mr:4:4:n', '深光の提灯', '深光のアンコウ王', 4, 4, 'normal', false, array['str'], 0.2, 2),
  ('mr:4:4:r', '暗海の顎', '深光のアンコウ王', 4, 4, 'rare', false, array['str'], 0.6, 2),
  ('mr:4:4:u', 'アンコウ王の光核', '深光のアンコウ王', 4, 4, 'ultra', false, array['str'], 1, 2),
  ('mr:5:0:n', '峰嵐の羽根', '峰嵐のグリフォンロード', 5, 5, 'normal', false, array['agi'], 0.2, 2.4),
  ('mr:5:0:r', '嵐王の鉤爪', '峰嵐のグリフォンロード', 5, 5, 'rare', false, array['agi'], 0.8, 2.4),
  ('mr:5:0:u', 'グリフォン王の風核', '峰嵐のグリフォンロード', 5, 5, 'ultra', false, array['agi'], 1.2, 2.4),
  ('mr:5:1:n', '巌骨の岩片', '巌骨のマウンテンゴーレム', 5, 5, 'normal', false, array['vit'], 0.2, 2.4),
  ('mr:5:1:r', '山骨の芯柱', '巌骨のマウンテンゴーレム', 5, 5, 'rare', false, array['vit'], 0.8, 2.4),
  ('mr:5:1:u', '山巨人の動力核', '巌骨のマウンテンゴーレム', 5, 5, 'ultra', false, array['vit'], 1.2, 2.4),
  ('mr:5:2:n', '払暁の竜鱗', '払暁の飛竜将', 5, 5, 'normal', false, array['str'], 0.2, 2.4),
  ('mr:5:2:r', '飛竜将の翼膜', '払暁の飛竜将', 5, 5, 'rare', false, array['str'], 0.8, 2.4),
  ('mr:5:2:u', '飛竜将の竜心', '払暁の飛竜将', 5, 5, 'ultra', false, array['str'], 1.2, 2.4),
  ('mr:5:3:n', '陽炎の剛毛', '陽炎の大猿王', 5, 5, 'normal', false, array['str'], 0.2, 2.4),
  ('mr:5:3:r', '大猿王の拳骨', '陽炎の大猿王', 5, 5, 'rare', false, array['str'], 0.8, 2.4),
  ('mr:5:3:u', '猿王の闘気核', '陽炎の大猿王', 5, 5, 'ultra', false, array['str'], 1.2, 2.4),
  ('mr:5:4:n', '宵闇の毛皮', '宵闇の山猫王', 5, 5, 'normal', false, array['agi'], 0.2, 2.4),
  ('mr:5:4:r', '山猫王の爪', '宵闇の山猫王', 5, 5, 'rare', false, array['agi'], 0.8, 2.4),
  ('mr:5:4:u', '宵闇王の瞳', '宵闇の山猫王', 5, 5, 'ultra', false, array['agi'], 1.2, 2.4),
  ('mr:6:0:n', '白牙の剛毛', '白牙のイエティロード', 6, 6, 'normal', false, array['str'], 0.2, 2.4),
  ('mr:6:0:r', 'イエティ王の牙', '白牙のイエティロード', 6, 6, 'rare', false, array['str'], 0.8, 2.4),
  ('mr:6:0:u', '雪王の氷心', '白牙のイエティロード', 6, 6, 'ultra', false, array['str'], 1.2, 2.4),
  ('mr:6:1:n', '氷鎧の竜鱗', '氷鎧のグレイシアドラゴン', 6, 6, 'normal', false, array['vit'], 0.2, 2.4),
  ('mr:6:1:r', '氷結の逆鱗', '氷鎧のグレイシアドラゴン', 6, 6, 'rare', false, array['vit'], 0.8, 2.4),
  ('mr:6:1:u', '氷竜の凍心', '氷鎧のグレイシアドラゴン', 6, 6, 'ultra', false, array['vit'], 1.2, 2.4),
  ('mr:6:2:n', '朝焼けの氷毛', '朝焼けの氷狼王', 6, 6, 'normal', false, array['agi'], 0.2, 2.4),
  ('mr:6:2:r', '氷狼王の牙', '朝焼けの氷狼王', 6, 6, 'rare', false, array['agi'], 0.8, 2.4),
  ('mr:6:2:u', '氷狼王の霜心', '朝焼けの氷狼王', 6, 6, 'ultra', false, array['agi'], 1.2, 2.4),
  ('mr:6:3:n', '樹氷女王の氷片', '白光の樹氷女王', 6, 6, 'normal', false, array['int_stat'], 0.2, 2.4),
  ('mr:6:3:r', '氷華の枝晶', '白光の樹氷女王', 6, 6, 'rare', false, array['int_stat'], 0.8, 2.4),
  ('mr:6:3:u', '樹氷女王の氷冠', '白光の樹氷女王', 6, 6, 'ultra', false, array['int_stat'], 1.2, 2.4),
  ('mr:6:4:n', '極夜の骨片', '極夜のワイト王', 6, 6, 'normal', false, array['hp'], 0.2, 2.4),
  ('mr:6:4:r', 'ワイト王の屍衣', '極夜のワイト王', 6, 6, 'rare', false, array['hp'], 0.8, 2.4),
  ('mr:6:4:u', '極夜王の魂核', '極夜のワイト王', 6, 6, 'ultra', false, array['hp'], 1.2, 2.4),
  ('mr:7:0:n', '業火の残炎', '業火のイフリート将', 7, 7, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:7:0:r', 'イフリートの焔核', '業火のイフリート将', 7, 7, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:7:0:u', '業火将の炎冠', '業火のイフリート将', 7, 7, 'ultra', false, array['int_stat'], 1.5, 3),
  ('mr:7:1:n', '溶鉄の岩塊', '溶鉄のマグマゴーレム', 7, 7, 'normal', false, array['vit'], 0.2, 3),
  ('mr:7:1:r', 'マグマの芯柱', '溶鉄のマグマゴーレム', 7, 7, 'rare', false, array['vit'], 0.9, 3),
  ('mr:7:1:u', '溶鉄王の炉心', '溶鉄のマグマゴーレム', 7, 7, 'ultra', false, array['vit'], 1.5, 3),
  ('mr:7:2:n', '暁炎の翼膜', '暁炎のフレイムロード', 7, 7, 'normal', false, array['str'], 0.2, 3),
  ('mr:7:2:r', 'フレイムロードの爪', '暁炎のフレイムロード', 7, 7, 'rare', false, array['str'], 0.9, 3),
  ('mr:7:2:u', '暁炎王の火心', '暁炎のフレイムロード', 7, 7, 'ultra', false, array['str'], 1.5, 3),
  ('mr:7:3:n', '陽獄の鱗', '陽獄のサラマンダー将', 7, 7, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:7:3:r', 'サラマンダーの火袋', '陽獄のサラマンダー将', 7, 7, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:7:3:u', '陽獄将の煉核', '陽獄のサラマンダー将', 7, 7, 'ultra', false, array['int_stat'], 1.5, 3),
  ('mr:7:4:n', '熾火の角片', '熾火の大悪魔', 7, 7, 'normal', false, array['str'], 0.2, 3),
  ('mr:7:4:r', '大悪魔の焔翼', '熾火の大悪魔', 7, 7, 'rare', false, array['str'], 0.9, 3),
  ('mr:7:4:u', '熾火王の魔心', '熾火の大悪魔', 7, 7, 'ultra', false, array['str'], 1.5, 3),
  ('mr:8:0:n', '蒼天の風切羽', '蒼天のハーピークイーン', 8, 8, 'normal', false, array['agi'], 0.2, 3),
  ('mr:8:0:r', 'ハーピー女王の爪', '蒼天のハーピークイーン', 8, 8, 'rare', false, array['agi'], 0.9, 3),
  ('mr:8:0:u', '女王の蒼天冠', '蒼天のハーピークイーン', 8, 8, 'ultra', false, array['agi'], 1.5, 3),
  ('mr:8:1:n', '雷雲の残片', '雷雲の大精霊', 8, 8, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:8:1:r', '大精霊の雷核', '雷雲の大精霊', 8, 8, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:8:1:u', '雷雲王の天核', '雷雲の大精霊', 8, 8, 'ultra', false, array['int_stat'], 1.5, 3),
  ('mr:8:2:n', '曙光の羽根', '曙光の熾天使', 8, 8, 'normal', false, array['mp'], 0.2, 3),
  ('mr:8:2:r', '熾天使の光輪', '曙光の熾天使', 8, 8, 'rare', false, array['mp'], 0.9, 3),
  ('mr:8:2:u', '熾天使の聖核', '曙光の熾天使', 8, 8, 'ultra', false, array['mp'], 1.5, 3),
  ('mr:8:3:n', '白昼の鬣', '白昼の天馬将', 8, 8, 'normal', false, array['agi'], 0.2, 3),
  ('mr:8:3:r', '天馬将の蹄鉄', '白昼の天馬将', 8, 8, 'rare', false, array['agi'], 0.9, 3),
  ('mr:8:3:u', '天馬将の翼心', '白昼の天馬将', 8, 8, 'ultra', false, array['agi'], 1.5, 3),
  ('mr:8:4:n', '星降りの羽根', '星降りの戦乙女長', 8, 8, 'normal', false, array['str'], 0.2, 3),
  ('mr:8:4:r', '戦乙女長の槍先', '星降りの戦乙女長', 8, 8, 'rare', false, array['str'], 0.9, 3),
  ('mr:8:4:u', '戦乙女長の星核', '星降りの戦乙女長', 8, 8, 'ultra', false, array['str'], 1.5, 3),
  ('mr:9:0:n', '砂王の外殻', '砂王のグレートワーム', 9, 4, 'normal', false, array['hp'], 0.2, 2),
  ('mr:9:0:r', 'グレートワームの環節', '砂王のグレートワーム', 9, 4, 'rare', false, array['hp'], 0.6, 2),
  ('mr:9:0:u', '砂王の砂心', '砂王のグレートワーム', 9, 4, 'ultra', false, array['hp'], 1, 2),
  ('mr:9:1:n', '黄金の包帯', '黄金のミイラ神官', 9, 4, 'normal', false, array['int_stat'], 0.2, 2),
  ('mr:9:1:r', '神官の護符', '黄金のミイラ神官', 9, 4, 'rare', false, array['int_stat'], 0.6, 2),
  ('mr:9:1:u', 'ミイラ神官の黄金心', '黄金のミイラ神官', 9, 4, 'ultra', false, array['int_stat'], 1, 2),
  ('mr:9:2:n', '陽炎の砂片', '陽炎の砂幻王', 9, 4, 'normal', false, array['int_stat'], 0.2, 2),
  ('mr:9:2:r', '砂幻の蜃気', '陽炎の砂幻王', 9, 4, 'rare', false, array['int_stat'], 0.6, 2),
  ('mr:9:2:u', '砂幻王の幻核', '陽炎の砂幻王', 9, 4, 'ultra', false, array['int_stat'], 1, 2),
  ('mr:9:3:n', '灼熱の獣毛', '灼熱の冥王アヌビス', 9, 4, 'normal', false, array['str'], 0.2, 2),
  ('mr:9:3:r', '冥王の杖片', '灼熱の冥王アヌビス', 9, 4, 'rare', false, array['str'], 0.6, 2),
  ('mr:9:3:u', 'アヌビスの冥核', '灼熱の冥王アヌビス', 9, 4, 'ultra', false, array['str'], 1, 2),
  ('mr:9:4:n', '月砂の毛皮', '月砂の狼王', 9, 4, 'normal', false, array['agi'], 0.2, 2),
  ('mr:9:4:r', '狼王の砂牙', '月砂の狼王', 9, 4, 'rare', false, array['agi'], 0.6, 2),
  ('mr:9:4:u', '月砂王の心臓', '月砂の狼王', 9, 4, 'ultra', false, array['agi'], 1, 2),
  ('mr:10:0:n', '樹海の樹皮', '樹海の食人王', 10, 5, 'normal', false, array['hp'], 0.2, 2.4),
  ('mr:10:0:r', '食人王の顎木', '樹海の食人王', 10, 5, 'rare', false, array['hp'], 0.8, 2.4),
  ('mr:10:0:u', '食人王の樹心', '樹海の食人王', 10, 5, 'ultra', false, array['hp'], 1.2, 2.4),
  ('mr:10:1:n', '毒霧の根片', '毒霧のマンドラ女王', 10, 5, 'normal', false, array['int_stat'], 0.2, 2.4),
  ('mr:10:1:r', 'マンドラ女王の葉', '毒霧のマンドラ女王', 10, 5, 'rare', false, array['int_stat'], 0.8, 2.4),
  ('mr:10:1:u', '女王の毒核', '毒霧のマンドラ女王', 10, 5, 'ultra', false, array['int_stat'], 1.2, 2.4),
  ('mr:10:2:n', '朝靄の苔皮', '朝靄の古樹王', 10, 5, 'normal', false, array['vit'], 0.2, 2.4),
  ('mr:10:2:r', '古樹王の年輪', '朝靄の古樹王', 10, 5, 'rare', false, array['vit'], 0.8, 2.4),
  ('mr:10:2:u', '古樹王の巨心', '朝靄の古樹王', 10, 5, 'ultra', false, array['vit'], 1.2, 2.4),
  ('mr:10:3:n', '木漏れ日の鱗粉', '木漏れ日の妖精姫', 10, 5, 'normal', false, array['mp'], 0.2, 2.4),
  ('mr:10:3:r', '妖精姫の羽衣', '木漏れ日の妖精姫', 10, 5, 'rare', false, array['mp'], 0.8, 2.4),
  ('mr:10:3:u', '妖精姫の光冠', '木漏れ日の妖精姫', 10, 5, 'ultra', false, array['mp'], 1.2, 2.4),
  ('mr:10:4:n', '常闇の哭布', '常闇の哭女王', 10, 5, 'normal', false, array['int_stat'], 0.2, 2.4),
  ('mr:10:4:r', '哭女王の涙晶', '常闇の哭女王', 10, 5, 'rare', false, array['int_stat'], 0.8, 2.4),
  ('mr:10:4:u', '哭女王の呪核', '常闇の哭女王', 10, 5, 'ultra', false, array['int_stat'], 1.2, 2.4),
  ('mr:11:0:n', '雷翼の羽根', '雷翼のストームロード', 11, 6, 'normal', false, array['agi'], 0.2, 2.4),
  ('mr:11:0:r', 'ストームロードの嘴', '雷翼のストームロード', 11, 6, 'rare', false, array['agi'], 0.8, 2.4),
  ('mr:11:0:u', '嵐王の雷核', '雷翼のストームロード', 11, 6, 'ultra', false, array['agi'], 1.2, 2.4),
  ('mr:11:1:n', '雷刃の石片', '雷刃のガーゴイル将', 11, 6, 'normal', false, array['vit'], 0.2, 2.4),
  ('mr:11:1:r', 'ガーゴイル将の翼石', '雷刃のガーゴイル将', 11, 6, 'rare', false, array['vit'], 0.8, 2.4),
  ('mr:11:1:u', '雷刃将の帯電核', '雷刃のガーゴイル将', 11, 6, 'ultra', false, array['vit'], 1.2, 2.4),
  ('mr:11:2:n', '暁雲の風切羽', '暁雲の雷鷹王', 11, 6, 'normal', false, array['dex'], 0.2, 2.4),
  ('mr:11:2:r', '雷鷹王の鉤爪', '暁雲の雷鷹王', 11, 6, 'rare', false, array['dex'], 0.8, 2.4),
  ('mr:11:2:u', '雷鷹王の雷眼', '暁雲の雷鷹王', 11, 6, 'ultra', false, array['dex'], 1.2, 2.4),
  ('mr:11:3:n', '雷光の残片', '雷光の大精霊', 11, 6, 'normal', false, array['int_stat'], 0.2, 2.4),
  ('mr:11:3:r', '大精霊の稲妻核', '雷光の大精霊', 11, 6, 'rare', false, array['int_stat'], 0.8, 2.4),
  ('mr:11:3:u', '雷光王の天核', '雷光の大精霊', 11, 6, 'ultra', false, array['int_stat'], 1.2, 2.4),
  ('mr:11:4:n', '雷鳴の竜鱗', '雷鳴の飛竜王', 11, 6, 'normal', false, array['str'], 0.2, 2.4),
  ('mr:11:4:r', '飛竜王の帯電膜', '雷鳴の飛竜王', 11, 6, 'rare', false, array['str'], 0.8, 2.4),
  ('mr:11:4:u', '飛竜王の雷心', '雷鳴の飛竜王', 11, 6, 'ultra', false, array['str'], 1.2, 2.4),
  ('mr:12:0:n', '沼獄の毒鱗', '沼獄のヒュドラ将', 12, 7, 'normal', false, array['hp'], 0.2, 3),
  ('mr:12:0:r', 'ヒュドラ将の首骨', '沼獄のヒュドラ将', 12, 7, 'rare', false, array['hp'], 0.9, 3),
  ('mr:12:0:u', 'ヒュドラ将の毒心', '沼獄のヒュドラ将', 12, 7, 'ultra', false, array['hp'], 1.5, 3),
  ('mr:12:1:n', '腐溶の粘液', '腐溶のスライムロード', 12, 7, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:12:1:r', 'スライム王の溶核', '腐溶のスライムロード', 12, 7, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:12:1:u', '腐溶王の腐心', '腐溶のスライムロード', 12, 7, 'ultra', false, array['int_stat'], 1.5, 3),
  ('mr:12:2:n', '朝霞の魂片', '朝霞の魂火王', 12, 7, 'normal', false, array['mp'], 0.2, 3),
  ('mr:12:2:r', '魂火王の灯芯', '朝霞の魂火王', 12, 7, 'rare', false, array['mp'], 0.9, 3),
  ('mr:12:2:u', '魂火王の霊核', '朝霞の魂火王', 12, 7, 'ultra', false, array['mp'], 1.5, 3),
  ('mr:12:3:n', '陽だまりの毒皮', '陽だまりの毒蛙王', 12, 7, 'normal', false, array['vit'], 0.2, 3),
  ('mr:12:3:r', '毒蛙王の毒腺', '陽だまりの毒蛙王', 12, 7, 'rare', false, array['vit'], 0.9, 3),
  ('mr:12:3:u', '毒蛙王の巨心', '陽だまりの毒蛙王', 12, 7, 'ultra', false, array['vit'], 1.5, 3),
  ('mr:12:4:n', '夜霧の腐肉', '夜霧の腐王', 12, 7, 'normal', false, array['str'], 0.2, 3),
  ('mr:12:4:r', '腐王の朽骨', '夜霧の腐王', 12, 7, 'rare', false, array['str'], 0.9, 3),
  ('mr:12:4:u', '腐王の疫核', '夜霧の腐王', 12, 7, 'ultra', false, array['str'], 1.5, 3),
  ('mr:13:0:n', '坑道の腐爪', '坑道の屍鬼王', 13, 7, 'normal', false, array['str'], 0.2, 3),
  ('mr:13:0:r', '屍鬼王の顎骨', '坑道の屍鬼王', 13, 7, 'rare', false, array['str'], 0.9, 3),
  ('mr:13:0:u', '屍鬼王の飢核', '坑道の屍鬼王', 13, 7, 'ultra', false, array['str'], 1.5, 3),
  ('mr:13:1:n', '鉱晶の岩片', '鉱晶のゴーレム将', 13, 7, 'normal', false, array['vit'], 0.2, 3),
  ('mr:13:1:r', 'ゴーレム将の晶柱', '鉱晶のゴーレム将', 13, 7, 'rare', false, array['vit'], 0.9, 3),
  ('mr:13:1:u', '鉱晶将の動力核', '鉱晶のゴーレム将', 13, 7, 'ultra', false, array['vit'], 1.5, 3),
  ('mr:13:2:n', '曙光の晶殻', '曙光の晶蟲王', 13, 7, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:13:2:r', '晶蟲王の触角', '曙光の晶蟲王', 13, 7, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:13:2:u', '晶蟲王の輝核', '曙光の晶蟲王', 13, 7, 'ultra', false, array['int_stat'], 1.5, 3),
  ('mr:13:3:n', '灯火の鉱片', '灯火のドワーフ王', 13, 7, 'normal', false, array['dex'], 0.2, 3),
  ('mr:13:3:r', 'ドワーフ王の鎚', '灯火のドワーフ王', 13, 7, 'rare', false, array['dex'], 0.9, 3),
  ('mr:13:3:u', 'ドワーフ王の炉心', '灯火のドワーフ王', 13, 7, 'ultra', false, array['dex'], 1.5, 3),
  ('mr:13:4:n', '深穴の影片', '深穴の影王', 13, 7, 'normal', false, array['agi'], 0.2, 3),
  ('mr:13:4:r', '影王の暗衣', '深穴の影王', 13, 7, 'rare', false, array['agi'], 0.9, 3),
  ('mr:13:4:u', '影王の虚核', '深穴の影王', 13, 7, 'ultra', false, array['agi'], 1.5, 3),
  ('mr:14:0:n', '大石像の石片', '星読みの大石像', 14, 8, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:14:0:r', '大石像の星盤', '星読みの大石像', 14, 8, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:14:0:u', '星読みの天球核', '星読みの大石像', 14, 8, 'ultra', false, array['int_stat'], 1.5, 3),
  ('mr:14:1:n', '守護機神の外装', '遺跡の守護機神', 14, 8, 'normal', false, array['vit'], 0.2, 3),
  ('mr:14:1:r', '機神の魔導回路', '遺跡の守護機神', 14, 8, 'rare', false, array['vit'], 0.9, 3),
  ('mr:14:1:u', '機神の中枢核', '遺跡の守護機神', 14, 8, 'ultra', false, array['vit'], 1.5, 3),
  ('mr:14:2:n', '暁星の甲片', '暁星の星辰騎士', 14, 8, 'normal', false, array['str'], 0.2, 3),
  ('mr:14:2:r', '星辰騎士の剣先', '暁星の星辰騎士', 14, 8, 'rare', false, array['str'], 0.9, 3),
  ('mr:14:2:u', '星辰騎士の星心', '暁星の星辰騎士', 14, 8, 'ultra', false, array['str'], 1.5, 3),
  ('mr:14:3:n', '白日の獅毛', '白日の獅子王', 14, 8, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:14:3:r', '獅子王の謎符', '白日の獅子王', 14, 8, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:14:3:u', '獅子王の白日核', '白日の獅子王', 14, 8, 'ultra', false, array['int_stat'], 1.5, 3),
  ('mr:14:4:n', '星宿の月片', '星宿の月女神', 14, 8, 'normal', false, array['mp'], 0.2, 3),
  ('mr:14:4:r', '月女神の衣片', '星宿の月女神', 14, 8, 'rare', false, array['mp'], 0.9, 3),
  ('mr:14:4:u', '月女神の宿星核', '星宿の月女神', 14, 8, 'ultra', false, array['mp'], 1.5, 3),
  ('mr:15:0:n', '深淵の巨触手', '深淵のクラーケン王', 15, 8, 'normal', false, array['str'], 0.2, 3),
  ('mr:15:0:r', 'クラーケン王の吸盤', '深淵のクラーケン王', 15, 8, 'rare', false, array['str'], 0.9, 3),
  ('mr:15:0:u', 'クラーケン王の深核', '深淵のクラーケン王', 15, 8, 'ultra', false, array['str'], 1.5, 3),
  ('mr:15:1:n', '海淵の古鱗', '海淵の古龍', 15, 8, 'normal', false, array['vit'], 0.2, 3),
  ('mr:15:1:r', '古龍の逆鱗', '海淵の古龍', 15, 8, 'rare', false, array['vit'], 0.9, 3),
  ('mr:15:1:u', '古龍の海心', '海淵の古龍', 15, 8, 'ultra', false, array['vit'], 1.5, 3),
  ('mr:15:2:n', '朝凪の竜鱗', '朝凪の海竜王', 15, 8, 'normal', false, array['str'], 0.2, 3),
  ('mr:15:2:r', '海竜王の角', '朝凪の海竜王', 15, 8, 'rare', false, array['str'], 0.9, 3),
  ('mr:15:2:u', '海竜王の潮核', '朝凪の海竜王', 15, 8, 'ultra', false, array['str'], 1.5, 3),
  ('mr:15:3:n', '海皇鯨の皮', '陽射しの海皇鯨', 15, 8, 'normal', false, array['hp'], 0.2, 3),
  ('mr:15:3:r', '海皇鯨の巨骨', '陽射しの海皇鯨', 15, 8, 'rare', false, array['hp'], 0.9, 3),
  ('mr:15:3:u', '海皇鯨の潮心', '陽射しの海皇鯨', 15, 8, 'ultra', false, array['hp'], 1.5, 3),
  ('mr:15:4:n', '深海の鱗片', '深海の海妖女王', 15, 8, 'normal', false, array['int_stat'], 0.2, 3),
  ('mr:15:4:r', '海妖女王の歌晶', '深海の海妖女王', 15, 8, 'rare', false, array['int_stat'], 0.9, 3),
  ('mr:15:4:u', '海妖女王の深冠', '深海の海妖女王', 15, 8, 'ultra', false, array['int_stat'], 1.5, 3)
on conflict (id) do update set
