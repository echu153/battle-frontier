...
insert into public.v2_skills (name, cls, mp, sort) values
  ('はたく','ノーブル',0,1), ('狙い撃ち','ノーブル',5,2), ('応急手当','ノーブル',8,3), ('身構える','ノーブル',6,4), ('気合い','ノーブル',8,5), ('石つぶて','ノーブル',3,6), ('見切り','ノーブル',5,7), ('渾身の一撃','ノーブル',10,8), ('応援','ノーブル',6,9), ('手当ての心得','ノーブル',10,10),
  ('体当たり','戦士',5,1), ('強撃','戦士',12,2), ('防御崩し','戦士',10,3), ('防御態勢','戦士',8,4), ('シールドアタック','戦士',10,5), ('兜割り','戦士',9,6), ('大振り','戦士',13,7), ('二連撃','戦士',11,8), ('挑発','戦士',7,9), ('踏ん張り','戦士',6,10),
  ('狙撃','弓使い',8,1), ('剛射','弓使い',11,2), ('貫通射撃','弓使い',12,3), ('疾風矢','弓使い',8,4), ('駆け足','弓使い',6,5), ('速射','弓使い',5,6), ('火矢','弓使い',10,7), ('足払いの矢','弓使い',10,8), ('雨あられ','弓使い',12,9), ('集中','弓使い',7,10),
  ('マジックアロー','魔法使い',5,1), ('ファイア','魔法使い',11,2), ('サンダー','魔法使い',15,3), ('アイスランス','魔法使い',12,4), ('精神統一','魔法使い',8,5), ('ストーンバレット','魔法使い',5,6), ('ウィンドカッター','魔法使い',9,7), ('マナドレイン','魔法使い',12,8), ('フリーズ','魔法使い',13,9), ('詠唱加速','魔法使い',8,10),
  ('ライト','僧侶',6,1), ('ライトニング','僧侶',13,2), ('ヒール','僧侶',12,3), ('祈祷','僧侶',15,4), ('プロテク','僧侶',10,5), ('セイクリッドアロー','僧侶',6,6), ('裁きの光','僧侶',14,7), ('沈黙の祈り','僧侶',12,8), ('キュア','僧侶',7,9), ('ブレス','僧侶',9,10),
  ('打撃','格闘家',4,1), ('鉄拳','格闘家',12,2), ('連打','格闘家',10,3), ('爆裂拳','格闘家',16,4), ('残心','格闘家',8,5), ('蹴り上げ','格闘家',4,6), ('肘打ち','格闘家',10,7), ('双掌打','格闘家',9,8), ('崩し打ち','格闘家',9,9), ('体幹強化','格闘家',8,10),
  ('オオカミ召喚','サモナー',8,1), ('小悪魔召喚','サモナー',11,2), ('グリフォン召喚','サモナー',13,3), ('群れの号令','サモナー',14,4), ('魔力供給','サモナー',0,5), ('コウモリ召喚','サモナー',6,6), ('ゴーレム召喚','サモナー',12,7), ('影狼の牙','サモナー',13,8), ('使い魔の献身','サモナー',12,9), ('契約強化','サモナー',9,10),
  ...
  ('粛清','異端審問官',13,1), ('狂信','異端審問官',12,2), ('執行本能','異端審問官',0,3), ('聖なる裁き','異端審問官',17,4), ('断罪','異端審問官',21,5), ('尋問','異端審問官',13,6), ('拷問具','異端審問官',15,7), ('異端狩り','異端審問官',17,8), ('沈黙の枷','異端審問官',14,9), ('火刑','異端審問官',21,10),
  ('サンダーストライク','賢者',14,1), ('マナボルト','賢者',0,2), ('天啓','賢者',0,3), ('氷の障壁','賢者',15,4), ('メテオストライク','賢者',22,5), ('アルカナボルト','賢者',13,6), ('ディスペルウェーブ','賢者',16,7), ('インフェルノ','賢者',18,8), ('アストラルレイ','賢者',23,9), ('マナリカバリ','賢者',14,10),
  ('ホーリーエッジ','聖騎士',13,1), ('ディバインスマイト','聖騎士',16,2), ('聖騎士の心得','聖騎士',0,3), ('聖域展開','聖騎士',18,4), ('神聖覚醒','聖騎士',20,5), ('シールドバッシュ','聖騎士',13,6), ('ジャッジメントブロウ','聖騎士',17,7), ('ラストガード','聖騎士',19,8), ('誓いの盾','聖騎士',13,9), ('聖光の癒し','聖騎士',16,10),
  ('雷光斬','魔法剣士',13,1), ('閃光','魔法剣士',15,2), ('魔導剣術','魔法剣士',0,3), ('魔剣開放','魔法剣士',18,4), ('エレメンタルエッジ','魔法剣士',22,5), ('魔力刃','魔法剣士',14,6), ('氷結斬','魔法剣士',15,7), ('マナバースト','魔法剣士',17,8), ('天魔閃','魔法剣士',22,9), ('剣気開放','魔法剣士',15,10),
  ('魔弾','魔銃士',13,1), ('連装銃撃','魔銃士',15,2), ('精密照準','魔銃士',0,3), ('強化装填','魔銃士',16,4), ('キャノネスチュームビンド','魔銃士',22,5), ('速射弾','魔銃士',12,6), ('貫通弾','魔銃士',15,7), ('炸裂弾','魔銃士',16,8), ('フルバースト','魔銃士',22,9), ('曳光装填','魔銃士',14,10),
  ('サイコショット','サイキッカー',12,1), ('マインドブレイク','サイキッカー',15,2), ('第六感','サイキッカー',0,3), ('精神集中','サイキッカー',16,4), ('サイコブラスト','サイキッカー',21,5), ('テレキネシス','サイキッカー',13,6), ('サイコノイズ','サイキッカー',14,7), ('マインドスパイク','サイキッカー',17,8), ('サイキックチェイン','サイキッカー',20,9), ('精神加速','サイキッカー',15,10),
  ('半月蹴り','体術師',12,1), ('五連殺','体術師',20,2), ('闘争本能','体術師',0,3), ('破衝掌','体術師',16,4), ('飛天三角蹴り','体術師',17,5), ('旋風脚','体術師',12,6), ('当身','体術師',13,7), ('疾風連撃','体術師',16,8), ('崩落蹴','体術師',19,9), ('気孔術','体術師',14,10),
  ('ジャグリング','ギャンブラー',15,1), ('ラッキーダイス','ギャンブラー',13,2), ('ギャンブルボディ','ギャンブラー',0,3), ('オールイン','ギャンブラー',18,4), ('ジャックポット','ギャンブラー',22,5), ('コイントス','ギャンブラー',12,6), ('カードスロー','ギャンブラー',14,7), ('ラストベット','ギャンブラー',20,8), ('イカサマ','ギャンブラー',13,9), ('幸運の女神','ギャンブラー',14,10),
  ('ドラゴンスラスト','竜騎士',13,1), ('ドラゴンファング','竜騎士',17,2), ('竜鱗の加護','竜騎士',0,3), ('ドラゴンロア','竜騎士',14,4), ('天墜竜閃','竜騎士',22,5), ('ランスチャージ','竜騎士',13,6), ('竜鱗突き','竜騎士',15,7), ('空中殺法','竜騎士',19,8), ('威圧の咆哮','竜騎士',14,9), ('竜血覚醒','竜騎士',15,10),
  ('サラマンド','精霊召喚士',13,1), ('ウンディーネ','精霊召喚士',16,2), ('精霊共鳴','精霊召喚士',0,3), ('シルフ','精霊召喚士',14,4), ('ノーム','精霊召喚士',20,5), ('イフリート','精霊召喚士',16,6), ('マーメイド','精霊召喚士',13,7), ('精霊解放','精霊召喚士',22,8), ('ドリアード','精霊召喚士',16,9), ('フェニックス','精霊召喚士',20,10),
  ('符術・式打ち','式神使い',12,1), ('呪符・魂削り','式神使い',16,2), ('式神召喚','式神使い',0,3), ('陰陽結界','式神使い',15,4), ('禁術・神降ろし','式神使い',22,5), ('呪符・鬼火','式神使い',12,6), ('式符・鎌鼬','式神使い',16,7), ('呪詛返し','式神使い',15,8), ('封印符','式神使い',14,9), ('大祓','式神使い',16,10),
  ('ペット召喚','ブリーダー',0,1), ('攻撃して！','ブリーダー',14,2), ('一緒に頑張ろう！','ブリーダー',14,3), ('休憩しよう！','ブリーダー',16,4), ('やっちゃえ！','ブリーダー',22,5), ('かみつけ！','ブリーダー',13,6), ('とびかかれ！','ブリーダー',18,7), ('なでなで','ブリーダー',13,8), ('まもって！','ブリーダー',13,9), ('いっしょに走ろう！','ブリーダー',13,10),
  ('練気掌','武僧',12,1), ('活殺自在','武僧',14,2), ('心身一如','武僧',0,3), ('金剛身','武僧',15,4), ('崩拳','武僧',20,5), ('気功掌','武僧',12,6), ('三連震脚','武僧',17,7), ('破戒撃','武僧',16,8), ('自癒功','武僧',15,9), ('阿吽の呼吸','武僧',15,10),
  ('獣呼びの矢','ビーストレンジャー',12,1), ('群狼の牙','ビーストレンジャー',16,2), ('野性の勘','ビーストレンジャー',0,3), ('共鳴の咆哮','ビーストレンジャー',14,4), ('貫狼撃','ビーストレンジャー',20,5), ('鷹の急襲','ビーストレンジャー',13,6), ('熊の一撃','ビーストレンジャー',15,7), ('蛇毒の矢','ビーストレンジャー',14,8), ('疾風獣走','ビーストレンジャー',20,9), ('獣王の号令','ビーストレンジャー',14,10)
