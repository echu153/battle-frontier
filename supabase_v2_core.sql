...
insert into public.v2_skills (name, cls, mp, sort, req_jobs) values
  ...
  ('サイコショット','サイキッカー',12,1,0), ('マインドブレイク','サイキッカー',17,2,0), ('第六感','サイキッカー',0,3,0), ('精神集中','サイキッカー',16,4,0), ('サイコブラスト','サイキッカー',20,5,0), ('テレキネシス','サイキッカー',12,6,0), ('サイコノイズ','サイキッカー',15,7,0), ('マインドスパイク','サイキッカー',17,8,0), ('サイキックチェイン','サイキッカー',20,9,0), ('マインドアクセル','サイキッカー',15,10,0),
