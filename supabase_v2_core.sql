...
insert into public.v2_skills (name, cls, mp, sort) values
  ...
  ('居合斬','侍',12,1), ('断空','侍',16,2), ('居合の構え','侍',0,3), ('明鏡止水','侍',12,4), ('月影','侍',22,5),
  ...
  ('サンダーストライク','賢者',14,1), ('マナボルト','賢者',0,2), ('天啓','賢者',0,3), ('氷の障壁','賢者',15,4), ('メテオストライク','賢者',22,5),
  ...
  ('ジャグリング','ギャンブラー',15,1), ('ラッキーダイス','ギャンブラー',13,2), ('ギャンブルボディ','ギャンブラー',0,3), ('オールイン','ギャンブラー',18,4), ('ジャックポット','ギャンブラー',22,5),
  ('ドラゴンスラスト','竜騎士',13,1), ('ドラゴンファング','竜騎士',17,2), ('竜鱗の加護','竜騎士',0,3), ('ドラゴンロア','竜騎士',14,4), ('天墜竜閃','竜騎士',22,5),
  ('サラマンド','精霊召喚士',13,1), ('ウンディーネ','精霊召喚士',16,2), ('精霊共鳴','精霊召喚士',0,3), ('シルフ','精霊召喚士',14,4), ('ノーム','精霊召喚士',20,5),
  ('符術・式打ち','式神使い',12,1), ('呪符・魂削り','式神使い',16,2), ('式神召喚','式神使い',0,3), ('陰陽結界','式神使い',15,4), ('禁術・神降ろし','式神使い',22,5),
  ('ペット召喚','ブリーダー',0,1), ('攻撃して！','ブリーダー',14,2), ('一緒に頑張ろう！','ブリーダー',14,3), ('休憩しよう！','ブリーダー',16,4), ('やっちゃえ！','ブリーダー',22,5),
