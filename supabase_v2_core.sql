...
insert into public.v2_enemies (name, area, tier, slot, band, kind, power) values
  ('スライム', 1, 1, 'normal', null, 'phys', 450),
  ('コウモリ', 1, 1, 'normal', null, 'phys', 496),
  ('毒キノコ', 1, 1, 'normal', null, 'mag', 540),
  ('森ネズミ', 1, 1, 'normal', null, 'phys', 437),
  ('オオアリ', 1, 1, 'normal', null, 'phys', 510),
  ('つるヘビ', 1, 1, 'normal', null, 'phys', 573),
  ('朝露のフェアリー', 1, 1, 'timed', '朝', 'mag', 646),
  ('ひなたトカゲ', 1, 1, 'timed', '昼', 'phys', 646),
  ('月夜のフクロウ', 1, 1, 'timed', '晩', 'phys', 646),
  ('朝もやのカエル', 1, 1, 'timed', '朝', 'mag', 646),
  ('ひなたのチョウ', 1, 1, 'timed', '昼', 'mag', 646),
  ('夜鳴きのコオロギ', 1, 1, 'timed', '晩', 'phys', 646),
  ('ジェイドスライム', 1, 1, 'rare', null, 'phys', 1286),
  ('エンシェントトレント', 1, 1, 'rare', null, 'phys', 1286),
  ('オーロラフェアリー', 1, 1, 'rare', '朝', 'mag', 1286),
  ('サンリザード', 1, 1, 'rare', '昼', 'phys', 1286),
  ('ナイトオウル', 1, 1, 'rare', '晩', 'phys', 1286),
  ('ビッグスライム', 1, 1, 'boss', null, 'phys', 1286),
  ('ゴブリン', 2, 2, 'normal', null, 'phys', 791),
  ('野良犬', 2, 2, 'normal', null, 'phys', 853),
  ('盗賊', 2, 2, 'normal', null, 'phys', 950),
  ('草原オオカミ', 2, 2, 'normal', null, 'phys', 767),
  ('ゴブリン射手', 2, 2, 'normal', null, 'phys', 879),
  ('野伏せのイノシシ', 2, 2, 'normal', null, 'phys', 1007),
  ('朝霧のワーム', 2, 2, 'timed', '朝', 'phys', 1140),
  ('陽炎リザード', 2, 2, 'timed', '昼', 'phys', 1140),
  ('夜盗の斥候', 2, 2, 'timed', '晩', 'phys', 1140),
  ('朝露のオオバッタ', 2, 2, 'timed', '朝', 'phys', 1140),
  ('炎天のハゲタカ', 2, 2, 'timed', '昼', 'phys', 1140),
  ('夜盗の番犬', 2, 2, 'timed', '晩', 'phys', 1140),
  ('ホブゴブリン', 2, 2, 'rare', null, 'phys', 1860),
  ('シルバーフェンリル', 2, 2, 'rare', null, 'phys', 1860),
  ('ミストワーム', 2, 2, 'rare', '朝', 'phys', 1860),
  ('フレアバジリスク', 2, 2, 'rare', '昼', 'phys', 1860),
  ('シャドウシーフ', 2, 2, 'rare', '晩', 'phys', 1860),
  ('盗賊団のリーダー', 2, 2, 'boss', null, 'phys', 1860),
  ('コボルト', 3, 3, 'normal', null, 'phys', 1120),
  ('スケルトン', 3, 3, 'normal', null, 'phys', 1203),
  ('ゴーレム', 3, 3, 'normal', null, 'phys', 1311),
  ('洞窟グモ', 3, 3, 'normal', null, 'phys', 1084),
  ('コボルト投石手', 3, 3, 'normal', null, 'phys', 1237),
  ('スケルトンドッグ', 3, 3, 'normal', null, 'phys', 1390),
  ('曙のガーゴイル', 3, 3, 'timed', '朝', 'phys', 1569),
  ('石化トカゲ', 3, 3, 'timed', '昼', 'phys', 1569),
  ('夜這うレイス', 3, 3, 'timed', '晩', 'mag', 1569),
  ('朝陰のオオムカデ', 3, 3, 'timed', '朝', 'phys', 1569),
  ('石窟のサソリ', 3, 3, 'timed', '昼', 'phys', 1569),
  ('亡霊コボルト', 3, 3, 'timed', '晩', 'mag', 1569),
  ('オブシディアンコボルト', 3, 3, 'rare', null, 'phys', 2794),
  ('スケルトンナイト', 3, 3, 'rare', null, 'phys', 2794),
  ('ドーンガーゴイル', 3, 3, 'rare', '朝', 'phys', 2794),
  ('ロックバジリスク', 3, 3, 'rare', '昼', 'phys', 2794),
  ('ダークレイス', 3, 3, 'rare', '晩', 'mag', 2794),
  ('古代の番人', 3, 3, 'boss', null, 'mag', 2794),
  ('深海魚人', 4, 4, 'normal', null, 'phys', 1503),
  ('海賊', 4, 4, 'normal', null, 'phys', 1614),
  ('毒クラゲ', 4, 4, 'normal', null, 'mag', 1447),
  ('入り江のサメ', 4, 4, 'normal', null, 'phys', 1459),
  ('大ウミヘビ', 4, 4, 'normal', null, 'phys', 1663),
  ('海賊の砲手', 4, 4, 'normal', null, 'phys', 1534),
  ('朝凪のセイレーン', 4, 4, 'timed', '朝', 'mag', 1937),
  ('潮騒のカニ', 4, 4, 'timed', '昼', 'phys', 1937),
  ('夜光アンコウ', 4, 4, 'timed', '晩', 'phys', 1937),
  ('朝凪のトビウオ', 4, 4, 'timed', '朝', 'phys', 1937),
  ('日照りのウミガメ', 4, 4, 'timed', '昼', 'phys', 1937),
  ('夜光のタコ', 4, 4, 'timed', '晩', 'mag', 1937),
  ('コーラルナイト', 4, 4, 'rare', null, 'phys', 4606),
  ('ベビークラーケン', 4, 4, 'rare', null, 'phys', 4606),
  ('サンライズセイレーン', 4, 4, 'rare', '朝', 'mag', 4606),
  ('ジャイアントクラブ', 4, 4, 'rare', '昼', 'phys', 4606),
  ('ランタンアンコウ', 4, 4, 'rare', '晩', 'phys', 4606),
  ('シーサーペント', 4, 4, 'boss', null, 'phys', 4606),
  ('砂喰いワーム', 9, 4, 'normal', null, 'phys', 1559),
  ('墓守のミイラ', 9, 4, 'normal', null, 'phys', 1469),
  ('砂蠍サンドスコーピオン', 9, 4, 'normal', null, 'phys', 1536),
  ('遺丘のハゲワシ', 9, 4, 'normal', null, 'phys', 1512),
  ('砂のゴーレム', 9, 4, 'normal', null, 'phys', 1514),
  ('墓荒らしの盗掘者', 9, 4, 'normal', null, 'phys', 1629),
  ('陽炎の砂トカゲ', 9, 4, 'timed', '朝', 'mag', 1937),
  ('灼熱のアヌビス', 9, 4, 'timed', '昼', 'phys', 1937),
  ('月砂のジャッカル', 9, 4, 'timed', '晩', 'phys', 1937),
  ('朝日のスカラベ', 9, 4, 'timed', '朝', 'phys', 1937),
  ('灼熱のコブラ', 9, 4, 'timed', '昼', 'phys', 1937),
  ('月下のハイエナ', 9, 4, 'timed', '晩', 'phys', 1937),
  ('サンドワーム', 9, 4, 'rare', null, 'phys', 4606),
  ('ゴールデンマミー', 9, 4, 'rare', null, 'mag', 4606),
  ('ミラージュリザード', 9, 4, 'rare', '朝', 'mag', 4606),
  ('フレイムアヌビス', 9, 4, 'rare', '昼', 'phys', 4606),
  ('デザートウルフ', 9, 4, 'rare', '晩', 'phys', 4606),
  ('砂皇スカラベウス', 9, 4, 'boss', null, 'phys', 4606),
  ('山岳ゴブリン', 5, 5, 'normal', null, 'phys', 4288),
  ('岩石ゴーレム', 5, 5, 'normal', null, 'phys', 4873),
  ('グリフォン', 5, 5, 'normal', null, 'phys', 4580),
  ('峰のオオワシ', 5, 5, 'normal', null, 'phys', 4160),
  ('山岳トロール', 5, 5, 'normal', null, 'phys', 5019),
  ('岩場のヒグマ', 5, 5, 'normal', null, 'phys', 4855),
  ('払暁のワイバーン', 5, 5, 'timed', '朝', 'phys', 5847),
  ('陽射しの大猿', 5, 5, 'timed', '昼', 'phys', 5847),
  ('宵闇の山猫', 5, 5, 'timed', '晩', 'phys', 5847),
  ('払暁のハヤブサ', 5, 5, 'timed', '朝', 'phys', 5847),
  ('陽射しのヤマアラシ', 5, 5, 'timed', '昼', 'phys', 5847),
  ('宵闇のオオカミ', 5, 5, 'timed', '晩', 'phys', 5847),
  ('ストームグリフォン', 5, 5, 'rare', null, 'phys', 13144),
  ('マウンテンゴーレム', 5, 5, 'rare', null, 'phys', 13144),
  ('ドーンワイバーン', 5, 5, 'rare', '朝', 'phys', 13144),
  ('ブレイズゴリラ', 5, 5, 'rare', '昼', 'phys', 13144),
  ('シャドウキャット', 5, 5, 'rare', '晩', 'phys', 13144),
  ('雷鷲サンダーロック', 5, 5, 'boss', null, 'phys', 13144),
  ('食人樹', 10, 5, 'normal', null, 'phys', 4678),
  ('毒霧のマンドラゴラ', 10, 5, 'normal', null, 'mag', 4384),
  ('影狼シャドウウルフ', 10, 5, 'normal', null, 'phys', 4580),
  ('樹海のオオグモ', 10, 5, 'normal', null, 'phys', 4538),
  ('苔むしたゴーレム', 10, 5, 'normal', null, 'phys', 4518),
  ('人喰いのツタ', 10, 5, 'normal', null, 'phys', 4855),
  ('朝靄のトレント', 10, 5, 'timed', '朝', 'phys', 5847),
  ('木漏れ日のピクシー', 10, 5, 'timed', '昼', 'mag', 5847),
  ('常闇のバンシー', 10, 5, 'timed', '晩', 'mag', 5847),
  ('朝靄のマイコニド', 10, 5, 'timed', '朝', 'mag', 5847),
  ('木漏れ日のオオカブト', 10, 5, 'timed', '昼', 'phys', 5847),
  ('常闇のオオコウモリ', 10, 5, 'timed', '晩', 'phys', 5847),
  ('キラープラント', 10, 5, 'rare', null, 'phys', 13144),
  ('クイーンマンドラゴラ', 10, 5, 'rare', null, 'mag', 13144),
  ('ミストトレント', 10, 5, 'rare', '朝', 'phys', 13144),
  ('サンライトピクシー', 10, 5, 'rare', '昼', 'mag', 13144),
  ('クイーンバンシー', 10, 5, 'rare', '晩', 'mag', 13144),
  ('森王エルダートレント', 10, 5, 'boss', null, 'phys', 13144),
  ('雪男', 6, 6, 'normal', null, 'phys', 9871),
  ('氷河ドラゴン', 6, 6, 'normal', null, 'phys', 10858),
  ('霜の精霊', 6, 6, 'normal', null, 'mag', 9624),
  ('氷壁のゴーレム', 6, 6, 'normal', null, 'phys', 9574),
  ('白銀のシロクマ', 6, 6, 'normal', null, 'phys', 11182),
  ('霜のスケルトン', 6, 6, 'normal', null, 'phys', 10201),
  ('朝焼けの氷狼', 6, 6, 'timed', '朝', 'phys', 13029),
  ('白光の樹氷精', 6, 6, 'timed', '昼', 'mag', 13029),
  ('極夜のワイト', 6, 6, 'timed', '晩', 'phys', 13029),
  ('朝焼けのアイスドレイク', 6, 6, 'timed', '朝', 'mag', 13029),
  ('白光のスノーハーピー', 6, 6, 'timed', '昼', 'phys', 13029),
  ('極夜のリッチ', 6, 6, 'timed', '晩', 'mag', 13029),
  ('イエティロード', 6, 6, 'rare', null, 'phys', 24412),
  ('グレイシアドラゴン', 6, 6, 'rare', null, 'phys', 24412),
  ('ブリザードウルフ', 6, 6, 'rare', '朝', 'phys', 24412),
  ('アイスドライアド', 6, 6, 'rare', '昼', 'mag', 24412),
  ('ワイトキング', 6, 6, 'rare', '晩', 'phys', 24412),
  ('氷霊フロストバーン', 6, 6, 'boss', null, 'mag', 24412),
  ('嵐鳥ストームバード', 11, 6, 'normal', null, 'phys', 10117),
  ('雷刃のガーゴイル', 11, 6, 'normal', null, 'phys', 10611),
  ('断崖のトロール', 11, 6, 'normal', null, 'phys', 9871),
  ('断崖のコンドル', 11, 6, 'normal', null, 'phys', 9813),
  ('帯電のゴーレム', 11, 6, 'normal', null, 'mag', 10929),
  ('雷牙のオオカミ', 11, 6, 'normal', null, 'phys', 10462),
  ('暁雲のサンダーホーク', 11, 6, 'timed', '朝', 'phys', 13029),
  ('雷光のエレメンタル', 11, 6, 'timed', '昼', 'mag', 13029),
  ('雷鳴のワイバーン', 11, 6, 'timed', '晩', 'phys', 13029),
  ('暁雲のグリフォン', 11, 6, 'timed', '朝', 'phys', 13029),
  ('雷光のドレイク', 11, 6, 'timed', '昼', 'mag', 13029),
  ('雷鳴のハーピー', 11, 6, 'timed', '晩', 'phys', 13029),
  ('ストームイーグル', 11, 6, 'rare', null, 'phys', 24412),
  ('サンダーガーゴイル', 11, 6, 'rare', null, 'phys', 24412),
  ('サンダーバード', 11, 6, 'rare', '朝', 'phys', 24412),
  ('サンダーエレメンタル', 11, 6, 'rare', '昼', 'mag', 24412),
  ('ボルトワイバーン', 11, 6, 'rare', '晩', 'phys', 24412),
  ('雷帝ケラウノス', 11, 6, 'boss', null, 'mag', 24412),
  ('炎の精霊', 7, 7, 'normal', null, 'mag', 12514),
  ('溶岩ゴーレム', 7, 7, 'normal', null, 'phys', 13943),
  ('ファイアドレイク', 7, 7, 'normal', null, 'phys', 13229),
  ('溶岩スライム', 7, 7, 'normal', null, 'mag', 12138),
  ('火口のヘルハウンド', 7, 7, 'normal', null, 'phys', 14361),
  ('燃えさかるインプ', 7, 7, 'normal', null, 'mag', 14022),
  ('暁のフレイムバット', 7, 7, 'timed', '朝', 'phys', 16731),
  ('陽炎のイフリート', 7, 7, 'timed', '昼', 'mag', 16731),
  ('熾火のデーモン', 7, 7, 'timed', '晩', 'phys', 16731),
  ('暁炎のフェニックス', 7, 7, 'timed', '朝', 'mag', 16731),
  ('陽炎のケルベロス', 7, 7, 'timed', '昼', 'phys', 16731),
  ('熾火のワイバーン', 7, 7, 'timed', '晩', 'phys', 16731),
  ('イフリートロード', 7, 7, 'rare', null, 'mag', 34769),
  ('マグマゴーレム', 7, 7, 'rare', null, 'phys', 34769),
  ('ブレイズバット', 7, 7, 'rare', '朝', 'phys', 34769),
  ('サラマンダーロード', 7, 7, 'rare', '昼', 'mag', 34769),
  ('アークデーモン', 7, 7, 'rare', '晩', 'phys', 34769),
  ('深紅のサラマンダー', 7, 7, 'boss', null, 'phys', 34769),
  ('沼のヒュドラ', 12, 7, 'normal', null, 'phys', 13586),
  ('腐食スライム', 12, 7, 'normal', null, 'mag', 12514),
  ('沼底のリザードマン', 12, 7, 'normal', null, 'phys', 13229),
  ('沼のオオワニ', 12, 7, 'normal', null, 'phys', 13178),
  ('腐肉のオオバエ', 12, 7, 'normal', null, 'phys', 12889),
  ('泥のゴーレム', 12, 7, 'normal', null, 'phys', 14022),
  ('朝霞のウィルオウィスプ', 12, 7, 'timed', '朝', 'mag', 16731),
  ('陽だまりの大蛙', 12, 7, 'timed', '昼', 'phys', 16731),
  ('夜霧のゾンビ', 12, 7, 'timed', '晩', 'phys', 16731),
  ('朝霞のオオヒル', 12, 7, 'timed', '朝', 'phys', 16731),
  ('陽だまりのオオヘビ', 12, 7, 'timed', '昼', 'phys', 16731),
  ('夜霧のバジリスク', 12, 7, 'timed', '晩', 'mag', 16731),
  ('ヒュドラロード', 12, 7, 'rare', null, 'phys', 34769),
  ('アシッドスライム', 12, 7, 'rare', null, 'mag', 34769),
  ('グレーターウィスプ', 12, 7, 'rare', '朝', 'mag', 34769),
  ('ポイズンフロッグ', 12, 7, 'rare', '昼', 'phys', 34769),
  ('グレーターゾンビ', 12, 7, 'rare', '晩', 'phys', 34769),
  ('毒龍ヴェノムヒュドラ', 12, 7, 'boss', null, 'phys', 34769),
  ('坑道のグール', 13, 7, 'normal', null, 'phys', 12870),
  ('鉱石ゴーレム', 13, 7, 'normal', null, 'phys', 13943),
  ('闇喰いコウモリ', 13, 7, 'normal', null, 'phys', 12514),
  ('坑道のオオネズミ', 13, 7, 'normal', null, 'phys', 12485),
  ('錆びた自動人形', 13, 7, 'normal', null, 'phys', 14361),
  ('奈落のスケルトン兵', 13, 7, 'normal', null, 'phys', 13264),
  ('曙光のクリスタルワーム', 13, 7, 'timed', '朝', 'mag', 16731),
  ('灯火のドワーフ亡霊', 13, 7, 'timed', '昼', 'phys', 16731),
  ('深穴のシャドウ', 13, 7, 'timed', '晩', 'mag', 16731),
  ('曙光のクリスタルゴーレム', 13, 7, 'timed', '朝', 'mag', 16731),
  ('灯火のドワーフ坑夫', 13, 7, 'timed', '昼', 'phys', 16731),
  ('深穴のオオグモ', 13, 7, 'timed', '晩', 'phys', 16731),
  ('グールキング', 13, 7, 'rare', null, 'phys', 34769),
  ('ミスリルゴーレム', 13, 7, 'rare', null, 'phys', 34769),
  ('クリスタルワームロード', 13, 7, 'rare', '朝', 'mag', 34769),
  ('ドワーフキング', 13, 7, 'rare', '昼', 'phys', 34769),
  ('グレーターシャドウ', 13, 7, 'rare', '晩', 'mag', 34769),
  ('巌喰いガイアモール', 13, 7, 'boss', null, 'phys', 34769),
  ('天翼のハーピー', 8, 8, 'normal', null, 'phys', 17649),
  ('雷雲の精霊', 8, 8, 'normal', null, 'mag', 18451),
  ('天空騎士グリフィオン', 8, 8, 'normal', null, 'phys', 20054),
  ('蒼天のロック鳥', 8, 8, 'normal', null, 'phys', 17119),
  ('浮遊するゴーレム', 8, 8, 'normal', null, 'phys', 19003),
  ('天空の弓兵', 8, 8, 'normal', null, 'phys', 21258),
  ('曙光のセラフ', 8, 8, 'timed', '朝', 'mag', 24066),
  ('白昼のペガサス', 8, 8, 'timed', '昼', 'phys', 24066),
  ('星降りのヴァルキリー', 8, 8, 'timed', '晩', 'phys', 24066),
  ('曙光のケルビム', 8, 8, 'timed', '朝', 'mag', 24066),
  ('白昼のユニコーン', 8, 8, 'timed', '昼', 'phys', 24066),
  ('星降りのワイバーン', 8, 8, 'timed', '晩', 'phys', 24066),
  ('ハーピークイーン', 8, 8, 'rare', null, 'phys', 45247),
  ('ストームエレメンタル', 8, 8, 'rare', null, 'mag', 45247),
  ('アークセラフ', 8, 8, 'rare', '朝', 'mag', 45247),
  ('ペガサスロード', 8, 8, 'rare', '昼', 'phys', 45247),
  ('ヴァルキリーロード', 8, 8, 'rare', '晩', 'phys', 45247),
  ('天空覇龍ウラノス', 8, 8, 'boss', null, 'phys', 45247),
  ('星読みの石像', 14, 8, 'normal', null, 'mag', 19252),
  ('遺跡の守護機兵', 14, 8, 'normal', null, 'phys', 20054),
  ('時喰いのクロノワーム', 14, 8, 'normal', null, 'phys', 17649),
  ('星霜のゴーレム', 14, 8, 'normal', null, 'phys', 18675),
  ('遺跡の魔導兵', 14, 8, 'normal', null, 'mag', 20657),
  ('時喰いのカゲロウ', 14, 8, 'normal', null, 'phys', 18707),
  ('暁星のアストラルナイト', 14, 8, 'timed', '朝', 'phys', 24066),
  ('白日のスフィンクス', 14, 8, 'timed', '昼', 'mag', 24066),
  ('星宿の月狼ルナウルフ', 14, 8, 'timed', '晩', 'mag', 24066),
  ('暁星のケンタウロス', 14, 8, 'timed', '朝', 'phys', 24066),
  ('白日のマンティコア', 14, 8, 'timed', '昼', 'phys', 24066),
  ('星宿の月蛾', 14, 8, 'timed', '晩', 'mag', 24066),
  ('スターゴーレム', 14, 8, 'rare', null, 'mag', 45247),
  ('ガーディアンゴーレム', 14, 8, 'rare', null, 'phys', 45247),
  ('セレスティアルナイト', 14, 8, 'rare', '朝', 'phys', 45247),
  ('スフィンクスロード', 14, 8, 'rare', '昼', 'mag', 45247),
  ('ルナウルフキング', 14, 8, 'rare', '晩', 'mag', 45247),
  ('時星龍アイオーン', 14, 8, 'boss', null, 'mag', 45247),
  ('深淵のクラーケン', 15, 8, 'normal', null, 'phys', 20054),
  ('海淵のリヴァイアサン幼体', 15, 8, 'normal', null, 'phys', 18933),
  ('冥暗のシーウィッチ', 15, 8, 'normal', null, 'mag', 17649),
  ('深海のメガロドン', 15, 8, 'normal', null, 'phys', 19453),
  ('海溝のダイオウイカ', 15, 8, 'normal', null, 'phys', 19501),
  ('冥暗のマーマン', 15, 8, 'normal', null, 'phys', 18707),
  ('朝凪の海竜', 15, 8, 'timed', '朝', 'phys', 24066),
  ('陽射しの巨鯨', 15, 8, 'timed', '昼', 'phys', 24066),
  ('深海のセイレーン', 15, 8, 'timed', '晩', 'mag', 24066),
  ('朝凪のシャチ', 15, 8, 'timed', '朝', 'phys', 24066),
  ('陽射しのマンタ', 15, 8, 'timed', '昼', 'phys', 24066),
  ('深海のオオダコ', 15, 8, 'timed', '晩', 'mag', 24066),
  ('クラーケンキング', 15, 8, 'rare', null, 'phys', 45247),
  ('エンシェントドラゴン', 15, 8, 'rare', null, 'phys', 45247),
  ('アビスサーペント', 15, 8, 'rare', '朝', 'phys', 45247),
  ('グレートホエール', 15, 8, 'rare', '昼', 'phys', 45247),
  ('セイレーンクイーン', 15, 8, 'rare', '晩', 'mag', 45247),
  ('深海覇王リヴァイアサン', 15, 8, 'boss', null, 'phys', 45247)
