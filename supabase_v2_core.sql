...
insert into public.v2_skills (name, cls, mp, sort, req_jobs) values
  ...
  ('マッドラッシュ','狂戦士',16,1,0), ('すてみ','狂戦士',22,2,0), ('バーサク','狂戦士',0,3,0), ('ブラッティロア','狂戦士',14,4,0), ('フルブレイカー','狂戦士',16,5,0), ('猛り斬り','狂戦士',12,6,5), ('狂心','狂戦士',16,7,5), ('血啜り','狂戦士',14,8,5), ('狂乱連斬','狂戦士',20,9,5), ('威嚇咆哮','狂戦士',12,10,5),
  ('毒矢','狩人',12,1,0), ('三連射','狩人',16,2,0), ('鷹ノ目','狩人',0,3,0), ('狩猟本能','狩人',14,4,0), ('絶影狙撃','狩人',20,5,0), ('貫き矢','狩人',14,6,5), ('追い討ち','狩人',14,7,5), ('スモークボム','狩人',16,8,5), ('鷹爪連射','狩人',20,9,5), ('トラップセット','狩人',13,10,5),
  ('瞬歩瞬殺','暗殺者',12,1,0), ('鬼影閃','暗殺者',16,2,0), ('隠身','暗殺者',0,3,0), ('影歩き','暗殺者',12,4,0), ('急所突き','暗殺者',20,5,0), ('背後刺し','暗殺者',14,6,5), ('毒刃','暗殺者',14,7,5), ('足首断ち','暗殺者',18,8,5), ('千刃乱舞','暗殺者',20,9,5), ('影分身','暗殺者',13,10,5),
  ('アクアショット','元素使い',13,1,0), ('アースクエイク','元素使い',17,2,0), ('元素共鳴','元素使い',0,3,0), ('ライトニングボルト','元素使い',17,4,0), ('フレイムバースト','元素使い',21,5,0), ('スパークショット','元素使い',13,6,5), ('アイスプリズン','元素使い',17,7,5), ('マグマフィスト','元素使い',17,8,5), ('エレメンタルレイン','元素使い',23,9,5), ('エレメントチャージ','元素使い',14,10,5),
  ('骸骨召喚','死霊使い',13,1,0), ('ソウルドレイン','死霊使い',17,2,0), ('骸の壁','死霊使い',0,3,0), ('腐敗霧','死霊使い',17,4,0), ('幽世ノ門','死霊使い',21,5,0), ('カースハンド','死霊使い',13,6,5), ('コープスポイズン','死霊使い',17,7,5), ('デスウェイル','死霊使い',17,8,5), ('ヘルチェイン','死霊使い',21,9,5), ('ライフコンバート','死霊使い',16,10,5),
  ('ホーリーライト','聖職者',13,1,0), ('奇跡','聖職者',18,2,0), ('神聖加護','聖職者',0,3,0), ('祈りの結界','聖職者',14,4,0), ('神罰執行','聖職者',21,5,0), ('セイントレイ','聖職者',13,6,5), ('ピュリファイ','聖職者',17,7,5), ('ジャッジライト','聖職者',17,8,5), ('メガヒール','聖職者',20,9,5), ('グレイスウィンド','聖職者',12,10,5),
  ('粛清','異端審問官',13,1,0), ('狂信','異端審問官',12,2,0), ('執行本能','異端審問官',0,3,0), ('聖なる裁き','異端審問官',17,4,0), ('断罪','異端審問官',21,5,0), ('インクイジション','異端審問官',13,6,5), ('アイアンメイデン','異端審問官',17,7,5), ('ヘレティックハント','異端審問官',17,8,5), ('サイレンスチェイン','異端審問官',15,9,5), ('火刑','異端審問官',21,10,5),
  ('サンダーストライク','賢者',13,1,0), ('マナボルト','賢者',0,2,0), ('天啓','賢者',0,3,0), ('氷の障壁','賢者',15,4,0), ('メテオストライク','賢者',23,5,0), ('アルカナボルト','賢者',13,6,5), ('ディスペルウェーブ','賢者',17,7,5), ('インフェルノ','賢者',17,8,5), ('アストラルレイ','賢者',23,9,5), ('マナリカバリ','賢者',14,10,5),
  ('ホーリーエッジ','聖騎士',12,1,0), ('ディバインスマイト','聖騎士',16,2,0), ('聖騎士の心得','聖騎士',0,3,0), ('聖域展開','聖騎士',18,4,0), ('神聖覚醒','聖騎士',20,5,0), ('シールドバッシュ','聖騎士',12,6,5), ('ジャッジメントブロウ','聖騎士',16,7,5), ('ラストガード','聖騎士',18,8,5), ('オースシールド','聖騎士',13,9,5), ('ホーリーケア','聖騎士',16,10,5),
  ('雷光斬','魔法剣士',12,1,0), ('閃光','魔法剣士',12,2,0), ('魔導剣術','魔法剣士',0,3,0), ('魔剣開放','魔法剣士',18,4,0), ('エレメンタルエッジ','魔法剣士',20,5,0), ('マナエッジ','魔法剣士',12,6,5), ('フロストエッジ','魔法剣士',14,7,5), ('マナバースト','魔法剣士',17,8,5), ('天魔閃','魔法剣士',20,9,5), ('ソードオーラ','魔法剣士',15,10,5),
  ('魔弾','魔銃士',16,1,0), ('連装銃撃','魔銃士',16,2,0), ('精密照準','魔銃士',0,3,0), ('強化装填','魔銃士',16,4,0), ('キャノネスチュームビンド','魔銃士',20,5,0), ('ラピッドショット','魔銃士',11,6,5), ('ピアースバレット','魔銃士',14,7,5), ('バーストショット','魔銃士',16,8,5), ('フルバースト','魔銃士',22,9,5), ('トレーサーロード','魔銃士',14,10,5),
  ('サイコショット','サイキッカー',13,1,0), ('マインドブレイク','サイキッカー',17,2,0), ('第六感','サイキッカー',0,3,0), ('精神集中','サイキッカー',16,4,0), ('サイコブラスト','サイキッカー',21,5,0), ('テレキネシス','サイキッカー',13,6,5), ('サイコノイズ','サイキッカー',15,7,5), ('マインドスパイク','サイキッカー',17,8,5), ('サイキックチェイン','サイキッカー',20,9,5), ('マインドアクセル','サイキッカー',15,10,5),
  ('半月蹴り','体術師',12,1,0), ('五連殺','体術師',20,2,0), ('闘争本能','体術師',0,3,0), ('破衝掌','体術師',16,4,0), ('飛天三角蹴り','体術師',22,5,0), ('旋風脚','体術師',11,6,5), ('当身','体術師',14,7,5), ('疾風連撃','体術師',16,8,5), ('崩落蹴','体術師',18,9,5), ('気孔術','体術師',14,10,5),
  ('ジャグリング','ギャンブラー',16,1,0), ('ラッキーダイス','ギャンブラー',16,2,0), ('ギャンブルボディ','ギャンブラー',0,3,0), ('オールイン','ギャンブラー',18,4,0), ('ジャックポット','ギャンブラー',22,5,0), ('コイントス','ギャンブラー',12,6,5), ('カードスロー','ギャンブラー',16,7,5), ('ラストベット','ギャンブラー',20,8,5), ('イカサマ','ギャンブラー',13,9,5), ('レディラック','ギャンブラー',14,10,5),
  ('ドラゴンスラスト','竜騎士',12,1,0), ('ドラゴンファング','竜騎士',16,2,0), ('竜鱗の加護','竜騎士',0,3,0), ('ドラゴンロア','竜騎士',14,4,0), ('天墜竜閃','竜騎士',22,5,0), ('ランスチャージ','竜騎士',12,6,5), ('スケイルピアス','竜騎士',14,7,5), ('ドラゴンダイブ','竜騎士',18,8,5), ('インティミデイト','竜騎士',14,9,5), ('ドラゴンブラッド','竜騎士',15,10,5),
  ('サラマンド','精霊召喚士',13,1,0), ('ウンディーネ','精霊召喚士',16,2,0), ('精霊共鳴','精霊召喚士',0,3,0), ('シルフ','精霊召喚士',13,4,0), ('ノーム','精霊召喚士',21,5,0), ('イフリート','精霊召喚士',15,6,5), ('マーメイド','精霊召喚士',13,7,5), ('精霊解放','精霊召喚士',23,8,5), ('ドリアード','精霊召喚士',16,9,5), ('フェニックス','精霊召喚士',20,10,5),
  ('符術・式打ち','式神使い',13,1,0), ('呪符・魂削り','式神使い',17,2,0), ('式神召喚','式神使い',0,3,0), ('陰陽結界','式神使い',15,4,0), ('禁術・神降ろし','式神使い',23,5,0), ('呪符・鬼火','式神使い',13,6,5), ('式符・鎌鼬','式神使い',17,7,5), ('呪詛返し','式神使い',17,8,5), ('封印符','式神使い',15,9,5), ('大祓','式神使い',16,10,5),
  ('練気掌','武僧',16,1,0), ('活殺自在','武僧',16,2,0), ('心身一如','武僧',0,3,0), ('金剛身','武僧',15,4,0), ('崩拳','武僧',18,5,0), ('気功掌','武僧',12,6,5), ('三連震脚','武僧',16,7,5), ('破戒撃','武僧',16,8,5), ('自癒功','武僧',15,9,5), ('阿吽の呼吸','武僧',15,10,5),
  ('獣呼びの矢','ビーストレンジャー',12,1,0), ('群狼の牙','ビーストレンジャー',17,2,0), ('野性の勘','ビーストレンジャー',0,3,0), ('共鳴の咆哮','ビーストレンジャー',14,4,0), ('貫狼撃','ビーストレンジャー',18,5,0), ('ホークダイブ','ビーストレンジャー',12,6,5), ('ベアクロー','ビーストレンジャー',14,7,5), ('バイパーアロー','ビーストレンジャー',16,8,5), ('ワイルドラッシュ','ビーストレンジャー',20,9,5), ('ビーストコール','ビーストレンジャー',14,10,5);
